...
}`;function zw(t,e,n){let i=new n_;const r=new Ye,o=new Ye,s=new Lt,a=new Iw({depthPacking:RS}),l=new Fw,u={},f=n.maxTextureSize,d={[Yi]:rn,[rn]:Yi,[ri]:ri},h=new $i({defines:{VSM_SAMPLES:8},uniforms:{shadow_pass:{value:null},resolution:{value:new Ye},radius:{value:4}},vertexShader:Ow,fragmentShader:kw}),m=h.clone();m.defines.HORIZONTAL_PASS=1;const _=new vi;_.setAttribute("position",new kn(new Float32Array([-1,-1,.5,3,-1,.5,-1,3,.5]),3));const x=new ui(_,h),p=this;this.enabled=!1,this.autoUpdate=!0,this.needsUpdate=!1,this.type=Dv;let c=this.type;this.render=function(A,T,L){if(p.enabled===!1||p.autoUpdate===!1&&p.needsUpdate===!1||A.length===0)return;const j=t.getRenderTarget(),y=t.getActiveCubeFace(),C=t.getActiveMipmapLevel(),J=t.state;J.setBlending(Gi),J.buffers.color.setClear(1,1,1,1),J.buffers.depth.setTest(!0),J.setScissorTest(!1);const Q=c!==ti&&this.type===ti,b=c===ti&&this.type!==ti;for(let X=0,W=A.length;X<W;X++){const $=A[X],P=$.shadow;if(P===void 0){console.warn("THREE.WebGLShadowMap:",$,"has no shadow.");continue}if(P.autoUpdate===!1&&P.needsUpdate===!1)continue;r.copy(P.mapSize);const I=P.getFrameExtents();if(r.multiply(I),o.copy(P.mapSize),(r.x>f||r.y>f)&&(r.x>f&&(o.x=Math.floor(f/I.x),r.x=o.x*I.x,P.mapSize.x=o.x),r.y>f&&(o.y=Math.floor(f/I.y),r.y=o.y*I.y,P.mapSize.y=o.y)),P.map===null||Q===!0||b===!0){const q=this.type!==ti?{minFilter:Xt,magFilter:Xt}:{};P.map!==null&&P.map.dispose(),P.map=new Rr(r.x,r.y,q),P.map.texture.name=$.name+".shadowMap",P.camera.updateProjectionMatrix()}t.setRenderTarget(P.map),t.clear();const H=P.getViewportCount();for(let q=0;q<H;q++){const ne=P.getViewport(q);s.set(o.x*ne.x,o.y*ne.y,o.x*ne.z,o.y*ne.w),J.viewport(s),P.updateMatrices($,q),i=P.getFrustum(),E(T,L,P.camera,$,this.type)}P.isPointLightShadow!==!0&&this.type===ti&&v(P,L),P.needsUpdate=!1}c=this.type,p.needsUpdate=!1,t.setRenderTarget(j,y,C)};function v(A,T){const L=e.update(x);h.defines.VSM_SAMPLES!==A.blurSamples&&(h.defines.VSM_SAMPLES=A.blurSamples,m.defines.VSM_SAMPLES=A.blurSamples,h.needsUpdate=!0,m.needsUpdate=!0),A.mapPass===null&&(A.mapPass=new Rr(r.x,r.y)),h.uniforms.shadow_pass.value=A.map.texture,h.uniforms.resolution.value=A.mapSize,h.uniforms.radius.value=A.radius,t.setRenderTarget(A.mapPass),t.clear(),t.renderBufferDirect(T,null,L,h,x,null),m.uniforms.shadow_pass.value=A.mapPass.texture,m.uniforms.resolution.value=A.mapSize,m.uniforms.radius.value=A.radius,t.setRenderTarget(A.map),t.clear(),t.renderBufferDirect(T,null,L,m,x,null)}function g(A,T,L,j){let y=null;const C=L.isPointLight===!0?A.customDistanceMaterial:A.customDepthMaterial;if(C!==void 0)y=C;else if(y=L.isPointLight===!0?l:a,t.localClippingEnabled&&T.clipShadows===!0&&Array.isArray(T.clippingPlanes)&&T.clippingPlanes.length!==0||T.displacementMap&&T.displacementScale!==0||T.alphaMap&&T.alphaTest>0||T.map&&T.alphaTest>0){const J=y.uuid,Q=T.uuid;let b=u[J];b===void 0&&(b={},u[J]=b);let X=b[Q];X===void 0&&(X=y.clone(),b[Q]=X,T.addEventListener("dispose",R)),y=X}if(y.visible=T.visible,y.wireframe=T.wireframe,j===ti?y.side=T.shadowSide!==null?T.shadowSide:T.side:y.side=T.shadowSide!==null?T.shadowSide:d[T.side],y.alphaMap=T.alphaMap,y.alphaTest=T.alphaTest,y.map=T.map,y.clipShadows=T.clipShadows,y.clippingPlanes=T.clippingPlanes,y.clipIntersection=T.clipIntersection,y.displacementMap=T.displacementMap,y.displacementScale=T.displacementScale,y.displacementBias=T.displacementBias,y.wireframeLinewidth=T.wireframeLinewidth,y.linewidth=T.linewidth,L.isPointLight===!0&&y.isMeshDistanceMaterial===!0){const J=t.properties.get(y);J.light=L}return y}function E(A,T,L,j,y){if(A.visible===!1)return;if(A.layers.test(T.layers)&&(A.isMesh||A.isLine||A.isPoints)&&(A.castShadow||A.receiveShadow&&y===ti)&&(!A.frustumCulled||i.intersectsObject(A))){A.modelViewMatrix.multiplyMatrices(L.matrixWorldInverse,A.matrixWorld);const Q=e.update(A),b=A.material;if(Array.isArray(b)){const X=Q.groups;for(let W=0,$=X.length;W<$;W++){const P=X[W],I=b[P.materialIndex];if(I&&I.visible){const H=g(A,I,j,y);A.onBeforeShadow(t,A,T,L,Q,H,P),t.renderBufferDirect(L,null,Q,H,A,P),A.onAfterShadow(t,A,T,L,Q,H,P)}}}else if(b.visible){const X=g(A,b,j,y);A.onBeforeShadow(t,A,T,L,Q,X,null),t.renderBufferDirect(L,null,Q,X,A,null),A.onAfterShadow(t,A,T,L,Q,X,null)}}const J=A.children;for(let Q=0,b=J.length;Q<b;Q++)E(J[Q],T,L,j,y)}function R(A){A.target.removeEventListener("dispose",R);for(const L in u){const j=u[L],y=A.target.uuid;y in j&&(j[y].dispose(),delete j[y])}}}function Bw(t,e,n){const i=n.isWebGL2;function r(){let D=!1;const ue=new Lt;let k=null;const oe=new Lt(0,0,0,0);return{setMask:function(de){k!==de&&!D&&(t.colorMask(de,de,de,de),k=de)},setLocked:function(de){D=de},setClear:function(de,Ve,Je,Rt,gn){gn===!0&&(de*=Rt,Ve*=Rt,Je*=Rt),ue.set(de,Ve,Je,Rt),oe.equals(ue)===!1&&(t.clearColor(de,Ve,Je,Rt),oe.copy(ue))},reset:function(){D=!1,k=null,oe.set(-1,0,0,0)}}}function o(){let D=!1,ue=null,k=null,oe=null;return{setTest:function(de){de?ge(t.DEPTH_TEST):$e(t.DEPTH_TEST)},setMask:function(de){ue!==de&&!D&&(t.depthMask(de),ue=de)},setFunc:function(de){if(k!==de){switch(de){case iS:t.depthFunc(t.NEVER);break;case rS:t.depthFunc(t.ALWAYS);break;case oS:t.depthFunc(t.LESS);break;case gl:t.depthFunc(t.LEQUAL);break;case sS:t.depthFunc(t.EQUAL);break;case aS:t.depthFunc(t.GEQUAL);break;case lS:t.depthFunc(t.GREATER);break;case uS:t.depthFunc(t.NOTEQUAL);break;default:t.depthFunc(t.LEQUAL)}k=de}},setLocked:function(de){D=de},setClear:function(de){oe!==de&&(t.clearDepth(de),oe=de)},reset:function(){D=!1,ue=null,k=null,oe=null}}}function s(){let D=!1,ue=null,k=null,oe=null,de=null,Ve=null,Je=null,Rt=null,gn=null;return{setTest:function(et){D||(et?ge(t.STENCIL_TEST):$e(t.STENCIL_TEST))},setMask:function(et){ue!==et&&!D&&(t.stencilMask(et),ue=et)},setFunc:function(et,Ht,Bn){(k!==et||oe!==Ht||de!==Bn)&&(t.stencilFunc(et,Ht,Bn),k=et,oe=Ht,de=Bn)},setOp:function(et,Ht,Bn){(Ve!==et||Je!==Ht||Rt!==Bn)&&(t.stencilOp(et,Ht,Bn),Ve=et,Je=Ht,Rt=Bn)},setLocked:function(et){D=et},setClear:function(et){gn!==et&&(t.clearStencil(et),gn=et)},reset:function(){D=!1,ue=null,k=null,oe=null,de=null,Ve=null,Je=null,Rt=null,gn=null}}}const a=new r,l=new o,u=new s,f=new WeakMap,d=new WeakMap;let h={},m={},_=new WeakMap,x=[],p=null,c=!1,v=null,g=null,E=null,R=null,A=null,T=null,L=null,j=new Ke(0,0,0),y=0,C=!1,J=null,Q=null,b=null,X=null,W=null;const $=t.getParameter(t.MAX_COMBINED_TEXTURE_IMAGE_UNITS);let P=!1,I=0;const H=t.getParameter(t.VERSION);H.indexOf("WebGL")!==-1?(I=parseFloat(/^WebGL (\d)/.exec(H)[1]),P=I>=1):H.indexOf("OpenGL ES")!==-1&&(I=parseFloat(/^OpenGL ES (\d)/.exec(H)[1]),P=I>=2);let q=null,ne={};const Ce=t.getParameter(t.SCISSOR_BOX),O=t.getParameter(t.VIEWPORT),K=new Lt().fromArray(Ce),le=new Lt().fromArray(O);function Te(D,ue,k,oe){const de=new Uint8Array(4),Ve=t.createTexture();t.bindTexture(D,Ve),t.texParameteri(D,t.TEXTURE_MIN_FILTER,t.NEAREST),t.texParameteri(D,t.TEXTURE_MAG_FILTER,t.NEAREST);for(let Je=0;Je<k;Je++)i&&(D===t.TEXTURE_3D||D===t.TEXTURE_2D_ARRAY)?t.texImage3D(ue,0,t.RGBA,1,1,oe,0,t.RGBA,t.UNSIGNED_BYTE,de):t.texImage2D(ue+Je,0,t.RGBA,1,1,0,t.RGBA,t.UNSIGNED_BYTE,de);return Ve}const ye={};ye[t.TEXTURE_2D]=Te(t.TEXTURE_2D,t.TEXTURE_2D,1),ye[t.TEXTURE_CUBE_MAP]=Te(t.TEXTURE_CUBE_MAP,t.TEXTURE_CUBE_MAP_POSITIVE_X,6),i&&(ye[t.TEXTURE_2D_ARRAY]=Te(t.TEXTURE_2D_ARRAY,t.TEXTURE_2D_ARRAY,1,1),ye[t.TEXTURE_3D]=Te(t.TEXTURE_3D,t.TEXTURE_3D,1,1)),a.setClear(0,0,0,1),l.setClear(1),u.setClear(0),ge(t.DEPTH_TEST),l.setFunc(gl),Se(!1),he(bh),ge(t.CULL_FACE),Ae(Gi);function ge(D){h[D]!==!0&&(t.enable(D),h[D]=!0)}function $e(D){h[D]!==!1&&(t.disable(D),h[D]=!1)}function Ee(D,ue){return m[D]!==ue?(t.bindFramebuffer(D,ue),m[D]=ue,i&&(D===t.DRAW_FRAMEBUFFER&&(m[t.FRAMEBUFFER]=ue),D===t.FRAMEBUFFER&&(m[t.DRAW_FRAMEBUFFER]=ue)),!0):!1}function U(D,ue){let k=x,oe=!1;if(D){k=_.get(ue),k===void 0&&(k=[],_.set(ue,k));const de=D.textures;if(k.length!==de.length||k[0]!==t.COLOR_ATTACHMENT0){for(let Ve=0,Je=de.length;Ve<Je;Ve++)k[Ve]=t.COLOR_ATTACHMENT0+Ve;k.length=de.length,oe=!0}}else k[0]!==t.BACK&&(k[0]=t.BACK,oe=!0);if(oe)if(n.isWebGL2)t.drawBuffers(k);else if(e.has("WEBGL_draw_buffers")===!0)e.get("WEBGL_draw_buffers").drawBuffersWEBGL(k);else throw new Error("THREE.WebGLState: Usage of gl.drawBuffers() require WebGL2 or WEBGL_draw_buffers extension")}function xt(D){return p!==D?(t.useProgram(D),p=D,!0):!1}const Me={[fr]:t.FUNC_ADD,[Gy]:t.FUNC_SUBTRACT,[Vy]:t.FUNC_REVERSE_SUBTRACT};if(i)Me[Ih]=t.MIN,Me[Fh]=t.MAX;else{const D=e.get("EXT_blend_minmax");D!==null&&(Me[Ih]=D.MIN_EXT,Me[Fh]=D.MAX_EXT)}const Ue={[Wy]:t.ZERO,[Xy]:t.ONE,[jy]:t.SRC_COLOR,[Kc]:t.SRC_ALPHA,[Qy]:t.SRC_ALPHA_SATURATE,[Ky]:t.DST_COLOR,[$y]:t.DST_ALPHA,[Yy]:t.ONE_MINUS_SRC_COLOR,[Zc]:t.ONE_MINUS_SRC_ALPHA,[Zy]:t.ONE_MINUS_DST_COLOR,[qy]:t.ONE_MINUS_DST_ALPHA,[Jy]:t.CONSTANT_COLOR,[eS]:t.ONE_MINUS_CONSTANT_COLOR,[tS]:t.CONSTANT_ALPHA,[nS]:t.ONE_MINUS_CONSTANT_ALPHA};function Ae(D,ue,k,oe,de,Ve,Je,Rt,gn,et){if(D===Gi){c===!0&&($e(t.BLEND),c=!1);return}if(c===!1&&(ge(t.BLEND),c=!0),D!==Hy){if(D!==v||et!==C){if((g!==fr||A!==fr)&&(t.blendEquation(t.FUNC_ADD),g=fr,A=fr),et)switch(D){case go:t.blendFuncSeparate(t.ONE,t.ONE_MINUS_SRC_ALPHA,t.ONE,t.ONE_MINUS_SRC_ALPHA);break;case Dh:t.blendFunc(t.ONE,t.ONE);break;case Nh:t.blendFuncSeparate(t.ZERO,t.ONE_MINUS_SRC_COLOR,t.ZERO,t.ONE);break;case Uh:t.blendFuncSeparate(t.ZERO,t.SRC_COLOR,t.ZERO,t.SRC_ALPHA);break;default:console.error("THREE.WebGLState: Invalid blending: ",D);break}else switch(D){case go:t.blendFuncSeparate(t.SRC_ALPHA,t.ONE_MINUS_SRC_ALPHA,t.ONE,t.ONE_MINUS_SRC_ALPHA);break;case Dh:t.blendFunc(t.SRC_ALPHA,t.ONE);break;case Nh:t.blendFuncSeparate(t.ZERO,t.ONE_MINUS_SRC_COLOR,t.ZERO,t.ONE);break;case Uh:t.blendFunc(t.ZERO,t.SRC_COLOR);break;default:console.error("THREE.WebGLState: Invalid blending: ",D);break}E=null,R=null,T=null,L=null,j.set(0,0,0),y=0,v=D,C=et}return}de=de||ue,Ve=Ve||k,Je=Je||oe,(ue!==g||de!==A)&&(t.blendEquationSeparate(Me[ue],Me[de]),g=ue,A=de),(k!==E||oe!==R||Ve!==T||Je!==L)&&(t.blendFuncSeparate(Ue[k],Ue[oe],Ue[Ve],Ue[Je]),E=k,R=oe,T=Ve,L=Je),(Rt.equals(j)===!1||gn!==y)&&(t.blendColor(Rt.r,Rt.g,Rt.b,gn),j.copy(Rt),y=gn),v=D,C=!1}function He(D,ue){D.side===ri?$e(t.CULL_FACE):ge(t.CULL_FACE);let k=D.side===rn;ue&&(k=!k),Se(k),D.blending===go&&D.transparent===!1?Ae(Gi):Ae(D.blending,D.blendEquation,D.blendSrc,D.blendDst,D.blendEquationAlpha,D.blendSrcAlpha,D.blendDstAlpha,D.blendColor,D.blendAlpha,D.premultipliedAlpha),l.setFunc(D.depthFunc),l.setTest(D.depthTest),l.setMask(D.depthWrite),a.setMask(D.colorWrite);const oe=D.stencilWrite;u.setTest(oe),oe&&(u.setMask(D.stencilWriteMask),u.setFunc(D.stencilFunc,D.stencilRef,D.stencilFuncMask),u.setOp(D.stencilFail,D.stencilZFail,D.stencilZPass)),w(D.polygonOffset,D.polygonOffsetFactor,D.polygonOffsetUnits),D.alphaToCoverage===!0?ge(t.SAMPLE_ALPHA_TO_COVERAGE):$e(t.SAMPLE_ALPHA_TO_COVERAGE)}function Se(D){J!==D&&(D?t.frontFace(t.CW):t.frontFace(t.CCW),J=D)}function he(D){D!==ky?(ge(t.CULL_FACE),D!==Q&&(D===bh?t.cullFace(t.BACK):D===zy?t.cullFace(t.FRONT):t.cullFace(t.FRONT_AND_BACK))):$e(t.CULL_FACE),Q=D}function qe(D){D!==b&&(P&&t.lineWidth(D),b=D)}function w(D,ue,k){D?(ge(t.POLYGON_OFFSET_FILL),(X!==ue||W!==k)&&(t.polygonOffset(ue,k),X=ue,W=k)):$e(t.POLYGON_OFFSET_FILL)}function S(D){D?ge(t.SCISSOR_TEST):$e(t.SCISSOR_TEST)}function V(D){D===void 0&&(D=t.TEXTURE0+$-1),q!==D&&(t.activeTexture(D),q=D)}function Y(D,ue,k){k===void 0&&(q===null?k=t.TEXTURE0+$-1:k=q);let oe=ne[k];oe===void 0&&(oe={type:void 0,texture:void 0},ne[k]=oe),(oe.type!==D||oe.texture!==ue)&&(q!==k&&(t.activeTexture(k),q=k),t.bindTexture(D,ue||ye[D]),oe.type=D,oe.texture=ue)}function ie(){const D=ne[q];D!==void 0&&D.type!==void 0&&(t.bindTexture(D.type,null),D.type=void 0,D.texture=void 0)}function ee(){try{t.compressedTexImage2D.apply(t,arguments)}catch(D){console.error("THREE.WebGLState:",D)}}function Ie(){try{t.compressedTexImage3D.apply(t,arguments)}catch(D){console.error("THREE.WebGLState:",D)}}function Pe(){try{t.texSubImage2D.apply(t,arguments)}catch(D){console.error("THREE.WebGLState:",D)}}function ae(){try{t.texSubImage3D.apply(t,arguments)}catch(D){console.error("THREE.WebGLState:",D)}}function fe(){try{t.compressedTexSubImage2D.apply(t,arguments)}catch(D){console.error("THREE.WebGLState:",D)}}function Fe(){try{t.compressedTexSubImage3D.apply(t,arguments)}catch(D){console.error("THREE.WebGLState:",D)}}function re(){try{t.texStorage2D.apply(t,arguments)}catch(D){console.error("THREE.WebGLState:",D)}}function mt(){try{t.texStorage3D.apply(t,arguments)}catch(D){console.error("THREE.WebGLState:",D)}}function Ge(){try{t.texImage2D.apply(t,arguments)}catch(D){console.error("THREE.WebGLState:",D)}}function we(){try{t.texImage3D.apply(t,arguments)}catch(D){console.error("THREE.WebGLState:",D)}}function ve(D){K.equals(D)===!1&&(t.scissor(D.x,D.y,D.z,D.w),K.copy(D))}function _e(D){le.equals(D)===!1&&(t.viewport(D.x,D.y,D.z,D.w),le.copy(D))}function Xe(D,ue){let k=d.get(ue);k===void 0&&(k=new WeakMap,d.set(ue,k));let oe=k.get(D);oe===void 0&&(oe=t.getUniformBlockIndex(ue,D.name),k.set(D,oe))}function De(D,ue){const oe=d.get(ue).get(D);f.get(ue)!==oe&&(t.uniformBlockBinding(ue,oe,D.__bindingPointIndex),f.set(ue,oe))}function ot(){t.disable(t.BLEND),t.disable(t.CULL_FACE),t.disable(t.DEPTH_TEST),t.disable(t.POLYGON_OFFSET_FILL),t.disable(t.SCISSOR_TEST),t.disable(t.STENCIL_TEST),t.disable(t.SAMPLE_ALPHA_TO_COVERAGE),t.blendEquation(t.FUNC_ADD),t.blendFunc(t.ONE,t.ZERO),t.blendFuncSeparate(t.ONE,t.ZERO,t.ONE,t.ZERO),t.blendColor(0,0,0,0),t.colorMask(!0,!0,!0,!0),t.clearColor(0,0,0,0),t.depthMask(!0),t.depthFunc(t.LESS),t.clearDepth(1),t.stencilMask(4294967295),t.stencilFunc(t.ALWAYS,0,4294967295),t.stencilOp(t.KEEP,t.KEEP,t.KEEP),t.clearStencil(0),t.cullFace(t.BACK),t.frontFace(t.CCW),t.polygonOffset(0,0),t.activeTexture(t.TEXTURE0),t.bindFramebuffer(t.FRAMEBUFFER,null),i===!0&&(t.bindFramebuffer(t.DRAW_FRAMEBUFFER,null),t.bindFramebuffer(t.READ_FRAMEBUFFER,null)),t.useProgram(null),t.lineWidth(1),t.scissor(0,0,t.canvas.width,t.canvas.height),t.viewport(0,0,t.canvas.width,t.canvas.height),h={},q=null,ne={},m={},_=new WeakMap,x=[],p=null,c=!1,v=null,g=null,E=null,R=null,A=null,T=null,L=null,j=new Ke(0,0,0),y=0,C=!1,J=null,Q=null,b=null,X=null,W=null,K.set(0,0,t.canvas.width,t.canvas.height),le.set(0,0,t.canvas.width,t.canvas.height),a.reset(),l.reset(),u.reset()}return{buffers:{color:a,depth:l,stencil:u},enable:ge,disable:$e,bindFramebuffer:Ee,drawBuffers:U,useProgram:xt,setBlending:Ae,setMaterial:He,setFlipSided:Se,setCullFace:he,setLineWidth:qe,setPolygonOffset:w,setScissorTest:S,activeTexture:V,bindTexture:Y,unbindTexture:ie,compressedTexImage2D:ee,compressedTexImage3D:Ie,texImage2D:Ge,texImage3D:we,updateUBOMapping:Xe,uniformBlockBinding:De,texStorage2D:re,texStorage3D:mt,texSubImage2D:Pe,texSubImage3D:ae,compressedTexSubImage2D:fe,compressedTexSubImage3D:Fe,scissor:ve,viewport:_e,reset:ot}}function Hw(t,e,n,i,r,o,s){const a=r.isWebGL2,l=e.has("WEBGL_multisampled_render_to_texture")?e.get("WEBGL_multisampled_render_to_texture"):null,u=typeof navigator>"u"?!1:/OculusBrowser/g.test(navigator.userAgent),f=new Ye,d=new WeakMap;let h;const m=new WeakMap;let _=!1;try{_=typeof OffscreenCanvas<"u"&&new OffscreenCanvas(1,1).getContext("2d")!==null}catch{}function x(w,S){return _?new OffscreenCanvas(w,S):Sl("canvas")}function p(w,S,V,Y){let ie=1;const ee=qe(w);if((ee.width>Y||ee.height>Y)&&(ie=Y/Math.max(ee.width,ee.height)),ie<1||S===!0)if(typeof HTMLImageElement<"u"&&w instanceof HTMLImageElement||typeof HTMLCanvasElement<"u"&&w instanceof HTMLCanvasElement||typeof ImageBitmap<"u"&&w instanceof ImageBitmap||typeof VideoFrame<"u"&&w instanceof VideoFrame){const Ie=S?of:Math.floor,Pe=Ie(ie*ee.width),ae=Ie(ie*ee.height);h===void 0&&(h=x(Pe,ae));const fe=V?x(Pe,ae):h;return fe.width=Pe,fe.height=ae,fe.getContext("2d").drawImage(w,0,0,Pe,ae),console.warn("THREE.WebGLRenderer: Texture has been resized from ("+ee.width+"x"+ee.height+") to ("+Pe+"x"+ae+")."),fe}else return"data"in w&&console.warn("THREE.WebGLRenderer: Image in DataTexture is too big ("+ee.width+"x"+ee.height+")."),w;return w}function c(w){const S=qe(w);return dp(S.width)&&dp(S.height)}function v(w){return a?!1:w.wrapS!==Un||w.wrapT!==Un||w.minFilter!==Xt&&w.minFilter!==Kt}function g(w,S){return w.generateMipmaps&&S&&w.minFilter!==Xt&&w.minFilter!==Kt}function E(w){t.generateMipmap(w)}function R(w,S,V,Y,ie=!1){if(a===!1)return S;if(w!==null){if(t[w]!==void 0)return t[w];console.warn("THREE.WebGLRenderer: Attempt to use non-existing WebGL internal format '"+w+"'")}let ee=S;if(S===t.RED&&(V===t.FLOAT&&(ee=t.R32F),V===t.HALF_FLOAT&&(ee=t.R16F),V===t.UNSIGNED_BYTE&&(ee=t.R8)),S===t.RED_INTEGER&&(V===t.UNSIGNED_BYTE&&(ee=t.R8UI),V===t.UNSIGNED_SHORT&&(ee=t.R16UI),V===t.UNSIGNED_INT&&(ee=t.R32UI),V===t.BYTE&&(ee=t.R8I),V===t.SHORT&&(ee=t.R16I),V===t.INT&&(ee=t.R32I)),S===t.RG&&(V===t.FLOAT&&(ee=t.RG32F),V===t.HALF_FLOAT&&(ee=t.RG16F),V===t.UNSIGNED_BYTE&&(ee=t.RG8)),S===t.RG_INTEGER&&(V===t.UNSIGNED_BYTE&&(ee=t.RG8UI),V===t.UNSIGNED_SHORT&&(ee=t.RG16UI),V===t.UNSIGNED_INT&&(ee=t.RG32UI),V===t.BYTE&&(ee=t.RG8I),V===t.SHORT&&(ee=t.RG16I),V===t.INT&&(ee=t.RG32I)),S===t.RGBA){const Ie=ie?vl:Qe.getTransfer(Y);V===t.FLOAT&&(ee=t.RGBA32F),V===t.HALF_FLOAT&&(ee=t.RGBA16F),V===t.UNSIGNED_BYTE&&(ee=Ie===it?t.SRGB8_ALPHA8:t.RGBA8),V===t.UNSIGNED_SHORT_4_4_4_4&&(ee=t.RGBA4),V===t.UNSIGNED_SHORT_5_5_5_1&&(ee=t.RGB5_A1)}return(ee===t.R16F||ee===t.R32F||ee===t.RG16F||ee===t.RG32F||ee===t.RGBA16F||ee===t.RGBA32F)&&e.get("EXT_color_buffer_float"),ee}function A(w,S,V){return g(w,V)===!0||w.isFramebufferTexture&&w.minFilter!==Xt&&w.minFilter!==Kt?Math.log2(Math.max(S.width,S.height))+1:w.mipmaps!==void 0&&w.mipmaps.length>0?w.mipmaps.length:w.isCompressedTexture&&Array.isArray(w.image)?S.mipmaps.length:1}function T(w){return w===Xt||w===Oh||w===Xo?t.NEAREST:t.LINEAR}function L(w){const S=w.target;S.removeEventListener("dispose",L),y(S),S.isVideoTexture&&d.delete(S)}function j(w){const S=w.target;S.removeEventListener("dispose",j),J(S)}function y(w){const S=i.get(w);if(S.__webglInit===void 0)return;const V=w.source,Y=m.get(V);if(Y){const ie=Y[S.__cacheKey];ie.usedTimes--,ie.usedTimes===0&&C(w),Object.keys(Y).length===0&&m.delete(V)}i.remove(w)}function C(w){const S=i.get(w);t.deleteTexture(S.__webglTexture);const V=w.source,Y=m.get(V);delete Y[S.__cacheKey],s.memory.textures--}function J(w){const S=i.get(w);if(w.depthTexture&&w.depthTexture.dispose(),w.isWebGLCubeRenderTarget)for(let Y=0;Y<6;Y++){if(Array.isArray(S.__webglFramebuffer[Y]))for(let ie=0;ie<S.__webglFramebuffer[Y].length;ie++)t.deleteFramebuffer(S.__webglFramebuffer[Y][ie]);else t.deleteFramebuffer(S.__webglFramebuffer[Y]);S.__webglDepthbuffer&&t.deleteRenderbuffer(S.__webglDepthbuffer[Y])}else{if(Array.isArray(S.__webglFramebuffer))for(let Y=0;Y<S.__webglFramebuffer.length;Y++)t.deleteFramebuffer(S.__webglFramebuffer[Y]);else t.deleteFramebuffer(S.__webglFramebuffer);if(S.__webglDepthbuffer&&t.deleteRenderbuffer(S.__webglDepthbuffer),S.__webglMultisampledFramebuffer&&t.deleteFramebuffer(S.__webglMultisampledFramebuffer),S.__webglColorRenderbuffer)for(let Y=0;Y<S.__webglColorRenderbuffer.length;Y++)S.__webglColorRenderbuffer[Y]&&t.deleteRenderbuffer(S.__webglColorRenderbuffer[Y]);S.__webglDepthRenderbuffer&&t.deleteRenderbuffer(S.__webglDepthRenderbuffer)}const V=w.textures;for(let Y=0,ie=V.length;Y<ie;Y++){const ee=i.get(V[Y]);ee.__webglTexture&&(t.deleteTexture(ee.__webglTexture),s.memory.textures--),i.remove(V[Y])}i.remove(w)}let Q=0;function b(){Q=0}function X(){const w=Q;return w>=r.maxTextures&&console.warn("THREE.WebGLTextures: Trying to use "+w+" texture units while this GPU supports only "+r.maxTextures),Q+=1,w}function W(w){const S=[];return S.push(w.wrapS),S.push(w.wrapT),S.push(w.wrapR||0),S.push(w.magFilter),S.push(w.minFilter),S.push(w.anisotropy),S.push(w.internalFormat),S.push(w.format),S.push(w.type),S.push(w.generateMipmaps),S.push(w.premultiplyAlpha),S.push(w.flipY),S.push(w.unpackAlignment),S.push(w.colorSpace),S.join()}function $(w,S){const V=i.get(w);if(w.isVideoTexture&&Se(w),w.isRenderTargetTexture===!1&&w.version>0&&V.__version!==w.version){const Y=w.image;if(Y===null)console.warn("THREE.WebGLRenderer: Texture marked for update but no image data found.");else if(Y.complete===!1)console.warn("THREE.WebGLRenderer: Texture marked for update but image is incomplete");else{le(V,w,S);return}}n.bindTexture(t.TEXTURE_2D,V.__webglTexture,t.TEXTURE0+S)}function P(w,S){const V=i.get(w);if(w.version>0&&V.__version!==w.version){le(V,w,S);return}n.bindTexture(t.TEXTURE_2D_ARRAY,V.__webglTexture,t.TEXTURE0+S)}function I(w,S){const V=i.get(w);if(w.version>0&&V.__version!==w.version){le(V,w,S);return}n.bindTexture(t.TEXTURE_3D,V.__webglTexture,t.TEXTURE0+S)}function H(w,S){const V=i.get(w);if(w.version>0&&V.__version!==w.version){Te(V,w,S);return}n.bindTexture(t.TEXTURE_CUBE_MAP,V.__webglTexture,t.TEXTURE0+S)}const q={[ef]:t.REPEAT,[Un]:t.CLAMP_TO_EDGE,[tf]:t.MIRRORED_REPEAT},ne={[Xt]:t.NEAREST,[Oh]:t.NEAREST_MIPMAP_NEAREST,[Xo]:t.NEAREST_MIPMAP_LINEAR,[Kt]:t.LINEAR,[Mu]:t.LINEAR_MIPMAP_NEAREST,[gr]:t.LINEAR_MIPMAP_LINEAR},Ce={[bS]:t.NEVER,[OS]:t.ALWAYS,[DS]:t.LESS,[Gv]:t.LEQUAL,[NS]:t.EQUAL,[FS]:t.GEQUAL,[US]:t.GREATER,[IS]:t.NOTEQUAL};function O(w,S,V){if(S.type===oi&&e.has("OES_texture_float_linear")===!1&&(S.magFilter===Kt||S.magFilter===Mu||S.magFilter===Xo||S.magFilter===gr||S.minFilter===Kt||S.minFilter===Mu||S.minFilter===Xo||S.minFilter===gr)&&console.warn("THREE.WebGLRenderer: Unable to use linear filtering with floating point textures. OES_texture_float_linear not supported on this device."),V?(t.texParameteri(w,t.TEXTURE_WRAP_S,q[S.wrapS]),t.texParameteri(w,t.TEXTURE_WRAP_T,q[S.wrapT]),(w===t.TEXTURE_3D||w===t.TEXTURE_2D_ARRAY)&&t.texParameteri(w,t.TEXTURE_WRAP_R,q[S.wrapR]),t.texParameteri(w,t.TEXTURE_MAG_FILTER,ne[S.magFilter]),t.texParameteri(w,t.TEXTURE_MIN_FILTER,ne[S.minFilter])):(t.texParameteri(w,t.TEXTURE_WRAP_S,t.CLAMP_TO_EDGE),t.texParameteri(w,t.TEXTURE_WRAP_T,t.CLAMP_TO_EDGE),(w===t.TEXTURE_3D||w===t.TEXTURE_2D_ARRAY)&&t.texParameteri(w,t.TEXTURE_WRAP_R,t.CLAMP_TO_EDGE),(S.wrapS!==Un||S.wrapT!==Un)&&console.warn("THREE.WebGLRenderer: Texture is not power of two. Texture.wrapS and Texture.wrapT should be set to THREE.ClampToEdgeWrapping."),t.texParameteri(w,t.TEXTURE_MAG_FILTER,T(S.magFilter)),t.texParameteri(w,t.TEXTURE_MIN_FILTER,T(S.minFilter)),S.minFilter!==Xt&&S.minFilter!==Kt&&console.warn("THREE.WebGLRenderer: Texture is not power of two. Texture.minFilter should be set to THREE.NearestFilter or THREE.LinearFilter.")),S.compareFunction&&(t.texParameteri(w,t.TEXTURE_COMPARE_MODE,t.COMPARE_REF_TO_TEXTURE),t.texParameteri(w,t.TEXTURE_COMPARE_FUNC,Ce[S.compareFunction])),e.has("EXT_texture_filter_anisotropic")===!0){if(S.magFilter===Xt||S.minFilter!==Xo&&S.minFilter!==gr||S.type===oi&&e.has("OES_texture_float_linear")===!1||a===!1&&S.type===Ls&&e.has("OES_texture_half_float_linear")===!1)return;if(S.anisotropy>1||i.get(S).__currentAnisotropy){const Y=e.get("EXT_texture_filter_anisotropic");t.texParameterf(w,Y.TEXTURE_MAX_ANISOTROPY_EXT,Math.min(S.anisotropy,r.getMaxAnisotropy())),i.get(S).__currentAnisotropy=S.anisotropy}}}function K(w,S){let V=!1;w.__webglInit===void 0&&(w.__webglInit=!0,S.addEventListener("dispose",L));const Y=S.source;let ie=m.get(Y);ie===void 0&&(ie={},m.set(Y,ie));const ee=W(S);if(ee!==w.__cacheKey){ie[ee]===void 0&&(ie[ee]={texture:t.createTexture(),usedTimes:0},s.memory.textures++,V=!0),ie[ee].usedTimes++;const Ie=ie[w.__cacheKey];Ie!==void 0&&(ie[w.__cacheKey].usedTimes--,Ie.usedTimes===0&&C(S)),w.__cacheKey=ee,w.__webglTexture=ie[ee].texture}return V}function le(w,S,V){let Y=t.TEXTURE_2D;(S.isDataArrayTexture||S.isCompressedArrayTexture)&&(Y=t.TEXTURE_2D_ARRAY),S.isData3DTexture&&(Y=t.TEXTURE_3D);const ie=K(w,S),ee=S.source;n.bindTexture(Y,w.__webglTexture,t.TEXTURE0+V);const Ie=i.get(ee);if(ee.version!==Ie.__version||ie===!0){n.activeTexture(t.TEXTURE0+V);const Pe=Qe.getPrimaries(Qe.workingColorSpace),ae=S.colorSpace===Pi?null:Qe.getPrimaries(S.colorSpace),fe=S.colorSpace===Pi||Pe===ae?t.NONE:t.BROWSER_DEFAULT_WEBGL;t.pixelStorei(t.UNPACK_FLIP_Y_WEBGL,S.flipY),t.pixelStorei(t.UNPACK_PREMULTIPLY_ALPHA_WEBGL,S.premultiplyAlpha),t.pixelStorei(t.UNPACK_ALIGNMENT,S.unpackAlignment),t.pixelStorei(t.UNPACK_COLORSPACE_CONVERSION_WEBGL,fe);const Fe=v(S)&&c(S.image)===!1;let re=p(S.image,Fe,!1,r.maxTextureSize);re=he(S,re);const mt=c(re)||a,Ge=o.convert(S.format,S.colorSpace);let we=o.convert(S.type),ve=R(S.internalFormat,Ge,we,S.colorSpace,S.isVideoTexture);O(Y,S,mt);let _e;const Xe=S.mipmaps,De=a&&S.isVideoTexture!==!0&&ve!==Hv,ot=Ie.__version===void 0||ie===!0,D=ee.dataReady,ue=A(S,re,mt);if(S.isDepthTexture)ve=t.DEPTH_COMPONENT,a?S.type===oi?ve=t.DEPTH_COMPONENT32F:S.type===Ni?ve=t.DEPTH_COMPONENT24:S.type===yr?ve=t.DEPTH24_STENCIL8:ve=t.DEPTH_COMPONENT16:S.type===oi&&console.error("WebGLRenderer: Floating point depth texture requires WebGL2."),S.format===Sr&&ve===t.DEPTH_COMPONENT&&S.type!==od&&S.type!==Ni&&(console.warn("THREE.WebGLRenderer: Use UnsignedShortType or UnsignedIntType for DepthFormat DepthTexture."),S.type=Ni,we=o.convert(S.type)),S.format===Co&&ve===t.DEPTH_COMPONENT&&(ve=t.DEPTH_STENCIL,S.type!==yr&&(console.warn("THREE.WebGLRenderer: Use UnsignedInt248Type for DepthStencilFormat DepthTexture."),S.type=yr,we=o.convert(S.type))),ot&&(De?n.texStorage2D(t.TEXTURE_2D,1,ve,re.width,re.height):n.texImage2D(t.TEXTURE_2D,0,ve,re.width,re.height,0,Ge,we,null));else if(S.isDataTexture)if(Xe.length>0&&mt){De&&ot&&n.texStorage2D(t.TEXTURE_2D,ue,ve,Xe[0].width,Xe[0].height);for(let k=0,oe=Xe.length;k<oe;k++)_e=Xe[k],De?D&&n.texSubImage2D(t.TEXTURE_2D,k,0,0,_e.width,_e.height,Ge,we,_e.data):n.texImage2D(t.TEXTURE_2D,k,ve,_e.width,_e.height,0,Ge,we,_e.data);S.generateMipmaps=!1}else De?(ot&&n.texStorage2D(t.TEXTURE_2D,ue,ve,re.width,re.height),D&&n.texSubImage2D(t.TEXTURE_2D,0,0,0,re.width,re.height,Ge,we,re.data)):n.texImage2D(t.TEXTURE_2D,0,ve,re.width,re.height,0,Ge,we,re.data);else if(S.isCompressedTexture)if(S.isCompressedArrayTexture){De&&ot&&n.texStorage3D(t.TEXTURE_2D_ARRAY,ue,ve,Xe[0].width,Xe[0].height,re.depth);for(let k=0,oe=Xe.length;k<oe;k++)_e=Xe[k],S.format!==In?Ge!==null?De?D&&n.compressedTexSubImage3D(t.TEXTURE_2D_ARRAY,k,0,0,0,_e.width,_e.height,re.depth,Ge,_e.data,0,0):n.compressedTexImage3D(t.TEXTURE_2D_ARRAY,k,ve,_e.width,_e.height,re.depth,0,_e.data,0,0):console.warn("THREE.WebGLRenderer: Attempt to load unsupported compressed texture format in .uploadTexture()"):De?D&&n.texSubImage3D(t.TEXTURE_2D_ARRAY,k,0,0,0,_e.width,_e.height,re.depth,Ge,we,_e.data):n.texImage3D(t.TEXTURE_2D_ARRAY,k,ve,_e.width,_e.height,re.depth,0,Ge,we,_e.data)}else{De&&ot&&n.texStorage2D(t.TEXTURE_2D,ue,ve,Xe[0].width,Xe[0].height);for(let k=0,oe=Xe.length;k<oe;k++)_e=Xe[k],S.format!==In?Ge!==null?De?D&&n.compressedTexSubImage2D(t.TEXTURE_2D,k,0,0,_e.width,_e.height,Ge,_e.data):n.compressedTexImage2D(t.TEXTURE_2D,k,ve,_e.width,_e.height,0,_e.data):console.warn("THREE.WebGLRenderer: Attempt to load unsupported compressed texture format in .uploadTexture()"):De?D&&n.texSubImage2D(t.TEXTURE_2D,k,0,0,_e.width,_e.height,Ge,we,_e.data):n.texImage2D(t.TEXTURE_2D,k,ve,_e.width,_e.height,0,Ge,we,_e.data)}else if(S.isDataArrayTexture)De?(ot&&n.texStorage3D(t.TEXTURE_2D_ARRAY,ue,ve,re.width,re.height,re.depth),D&&n.texSubImage3D(t.TEXTURE_2D_ARRAY,0,0,0,0,re.width,re.height,re.depth,Ge,we,re.data)):n.texImage3D(t.TEXTURE_2D_ARRAY,0,ve,re.width,re.height,re.depth,0,Ge,we,re.data);else if(S.isData3DTexture)De?(ot&&n.texStorage3D(t.TEXTURE_3D,ue,ve,re.width,re.height,re.depth),D&&n.texSubImage3D(t.TEXTURE_3D,0,0,0,0,re.width,re.height,re.depth,Ge,we,re.data)):n.texImage3D(t.TEXTURE_3D,0,ve,re.width,re.height,re.depth,0,Ge,we,re.data);else if(S.isFramebufferTexture){if(ot)if(De)n.texStorage2D(t.TEXTURE_2D,ue,ve,re.width,re.height);else{let k=re.width,oe=re.height;for(let de=0;de<ue;de++)n.texImage2D(t.TEXTURE_2D,de,ve,k,oe,0,Ge,we,null),k>>=1,oe>>=1}}else if(Xe.length>0&&mt){if(De&&ot){const k=qe(Xe[0]);n.texStorage2D(t.TEXTURE_2D,ue,ve,k.width,k.height)}for(let k=0,oe=Xe.length;k<oe;k++)_e=Xe[k],De?D&&n.texSubImage2D(t.TEXTURE_2D,k,0,0,Ge,we,_e):n.texImage2D(t.TEXTURE_2D,k,ve,Ge,we,_e);S.generateMipmaps=!1}else if(De){if(ot){const k=qe(re);n.texStorage2D(t.TEXTURE_2D,ue,ve,k.width,k.height)}D&&n.texSubImage2D(t.TEXTURE_2D,0,0,0,Ge,we,re)}else n.texImage2D(t.TEXTURE_2D,0,ve,Ge,we,re);g(S,mt)&&E(Y),Ie.__version=ee.version,S.onUpdate&&S.onUpdate(S)}w.__version=S.version}function Te(w,S,V){if(S.image.length!==6)return;const Y=K(w,S),ie=S.source;n.bindTexture(t.TEXTURE_CUBE_MAP,w.__webglTexture,t.TEXTURE0+V);const ee=i.get(ie);if(ie.version!==ee.__version||Y===!0){n.activeTexture(t.TEXTURE0+V);const Ie=Qe.getPrimaries(Qe.workingColorSpace),Pe=S.colorSpace===Pi?null:Qe.getPrimaries(S.colorSpace),ae=S.colorSpace===Pi||Ie===Pe?t.NONE:t.BROWSER_DEFAULT_WEBGL;t.pixelStorei(t.UNPACK_FLIP_Y_WEBGL,S.flipY),t.pixelStorei(t.UNPACK_PREMULTIPLY_ALPHA_WEBGL,S.premultiplyAlpha),t.pixelStorei(t.UNPACK_ALIGNMENT,S.unpackAlignment),t.pixelStorei(t.UNPACK_COLORSPACE_CONVERSION_WEBGL,ae);const fe=S.isCompressedTexture||S.image[0].isCompressedTexture,Fe=S.image[0]&&S.image[0].isDataTexture,re=[];for(let k=0;k<6;k++)!fe&&!Fe?re[k]=p(S.image[k],!1,!0,r.maxCubemapSize):re[k]=Fe?S.image[k].image:S.image[k],re[k]=he(S,re[k]);const mt=re[0],Ge=c(mt)||a,we=o.convert(S.format,S.colorSpace),ve=o.convert(S.type),_e=R(S.internalFormat,we,ve,S.colorSpace),Xe=a&&S.isVideoTexture!==!0,De=ee.__version===void 0||Y===!0,ot=ie.dataReady;let D=A(S,mt,Ge);O(t.TEXTURE_CUBE_MAP,S,Ge);let ue;if(fe){Xe&&De&&n.texStorage2D(t.TEXTURE_CUBE_MAP,D,_e,mt.width,mt.height);for(let k=0;k<6;k++){ue=re[k].mipmaps;for(let oe=0;oe<ue.length;oe++){const de=ue[oe];S.format!==In?we!==null?Xe?ot&&n.compressedTexSubImage2D(t.TEXTURE_CUBE_MAP_POSITIVE_X+k,oe,0,0,de.width,de.height,we,de.data):n.compressedTexImage2D(t.TEXTURE_CUBE_MAP_POSITIVE_X+k,oe,_e,de.width,de.height,0,de.data):console.warn("THREE.WebGLRenderer: Attempt to load unsupported compressed texture format in .setTextureCube()"):Xe?ot&&n.texSubImage2D(t.TEXTURE_CUBE_MAP_POSITIVE_X+k,oe,0,0,de.width,de.height,we,ve,de.data):n.texImage2D(t.TEXTURE_CUBE_MAP_POSITIVE_X+k,oe,_e,de.width,de.height,0,we,ve,de.data)}}}else{if(ue=S.mipmaps,Xe&&De){ue.length>0&&D++;const k=qe(re[0]);n.texStorage2D(t.TEXTURE_CUBE_MAP,D,_e,k.width,k.height)}for(let k=0;k<6;k++)if(Fe){Xe?ot&&n.texSubImage2D(t.TEXTURE_CUBE_MAP_POSITIVE_X+k,0,0,0,re[k].width,re[k].height,we,ve,re[k].data):n.texImage2D(t.TEXTURE_CUBE_MAP_POSITIVE_X+k,0,_e,re[k].width,re[k].height,0,we,ve,re[k].data);for(let oe=0;oe<ue.length;oe++){const Ve=ue[oe].image[k].image;Xe?ot&&n.texSubImage2D(t.TEXTURE_CUBE_MAP_POSITIVE_X+k,oe+1,0,0,Ve.width,Ve.height,we,ve,Ve.data):n.texImage2D(t.TEXTURE_CUBE_MAP_POSITIVE_X+k,oe+1,_e,Ve.width,Ve.height,0,we,ve,Ve.data)}}else{Xe?ot&&n.texSubImage2D(t.TEXTURE_CUBE_MAP_POSITIVE_X+k,0,0,0,we,ve,re[k]):n.texImage2D(t.TEXTURE_CUBE_MAP_POSITIVE_X+k,0,_e,we,ve,re[k]);for(let oe=0;oe<ue.length;oe++){const de=ue[oe];Xe?ot&&n.texSubImage2D(t.TEXTURE_CUBE_MAP_POSITIVE_X+k,oe+1,0,0,we,ve,de.image[k]):n.texImage2D(t.TEXTURE_CUBE_MAP_POSITIVE_X+k,oe+1,_e,we,ve,de.image[k])}}}g(S,Ge)&&E(t.TEXTURE_CUBE_MAP),ee.__version=ie.version,S.onUpdate&&S.onUpdate(S)}w.__version=S.version}function ye(w,S,V,Y,ie,ee){const Ie=o.convert(V.format,V.colorSpace),Pe=o.convert(V.type),ae=R(V.internalFormat,Ie,Pe,V.colorSpace);if(!i.get(S).__hasExternalTextures){const Fe=Math.max(1,S.width>>ee),re=Math.max(1,S.height>>ee);ie===t.TEXTURE_3D||ie===t.TEXTURE_2D_ARRAY?n.texImage3D(ie,ee,ae,Fe,re,S.depth,0,Ie,Pe,null):n.texImage2D(ie,ee,ae,Fe,re,0,Ie,Pe,null)}n.bindFramebuffer(t.FRAMEBUFFER,w),He(S)?l.framebufferTexture2DMultisampleEXT(t.FRAMEBUFFER,Y,ie,i.get(V).__webglTexture,0,Ae(S)):(ie===t.TEXTURE_2D||ie>=t.TEXTURE_CUBE_MAP_POSITIVE_X&&ie<=t.TEXTURE_CUBE_MAP_NEGATIVE_Z)&&t.framebufferTexture2D(t.FRAMEBUFFER,Y,ie,i.get(V).__webglTexture,ee),n.bindFramebuffer(t.FRAMEBUFFER,null)}function ge(w,S,V){if(t.bindRenderbuffer(t.RENDERBUFFER,w),S.depthBuffer&&!S.stencilBuffer){let Y=a===!0?t.DEPTH_COMPONENT24:t.DEPTH_COMPONENT16;if(V||He(S)){const ie=S.depthTexture;ie&&ie.isDepthTexture&&(ie.type===oi?Y=t.DEPTH_COMPONENT32F:ie.type===Ni&&(Y=t.DEPTH_COMPONENT24));const ee=Ae(S);He(S)?l.renderbufferStorageMultisampleEXT(t.RENDERBUFFER,ee,Y,S.width,S.height):t.renderbufferStorageMultisample(t.RENDERBUFFER,ee,Y,S.width,S.height)}else t.renderbufferStorage(t.RENDERBUFFER,Y,S.width,S.height);t.framebufferRenderbuffer(t.FRAMEBUFFER,t.DEPTH_ATTACHMENT,t.RENDERBUFFER,w)}else if(S.depthBuffer&&S.stencilBuffer){const Y=Ae(S);V&&He(S)===!1?t.renderbufferStorageMultisample(t.RENDERBUFFER,Y,t.DEPTH24_STENCIL8,S.width,S.height):He(S)?l.renderbufferStorageMultisampleEXT(t.RENDERBUFFER,Y,t.DEPTH24_STENCIL8,S.width,S.height):t.renderbufferStorage(t.RENDERBUFFER,t.DEPTH_STENCIL,S.width,S.height),t.framebufferRenderbuffer(t.FRAMEBUFFER,t.DEPTH_STENCIL_ATTACHMENT,t.RENDERBUFFER,w)}else{const Y=S.textures;for(let ie=0;ie<Y.length;ie++){const ee=Y[ie],Ie=o.convert(ee.format,ee.colorSpace),Pe=o.convert(ee.type),ae=R(ee.internalFormat,Ie,Pe,ee.colorSpace),fe=Ae(S);V&&He(S)===!1?t.renderbufferStorageMultisample(t.RENDERBUFFER,fe,ae,S.width,S.height):He(S)?l.renderbufferStorageMultisampleEXT(t.RENDERBUFFER,fe,ae,S.width,S.height):t.renderbufferStorage(t.RENDERBUFFER,ae,S.width,S.height)}}t.bindRenderbuffer(t.RENDERBUFFER,null)}function $e(w,S){if(S&&S.isWebGLCubeRenderTarget)throw new Error("Depth Texture with cube render targets is not supported");if(n.bindFramebuffer(t.FRAMEBUFFER,w),!(S.depthTexture&&S.depthTexture.isDepthTexture))throw new Error("renderTarget.depthTexture must be an instance of THREE.DepthTexture");(!i.get(S.depthTexture).__webglTexture||S.depthTexture.image.width!==S.width||S.depthTexture.image.height!==S.height)&&(S.depthTexture.image.width=S.width,S.depthTexture.image.height=S.height,S.depthTexture.needsUpdate=!0),$(S.depthTexture,0);const Y=i.get(S.depthTexture).__webglTexture,ie=Ae(S);if(S.depthTexture.format===Sr)He(S)?l.framebufferTexture2DMultisampleEXT(t.FRAMEBUFFER,t.DEPTH_ATTACHMENT,t.TEXTURE_2D,Y,0,ie):t.framebufferTexture2D(t.FRAMEBUFFER,t.DEPTH_ATTACHMENT,t.TEXTURE_2D,Y,0);else if(S.depthTexture.format===Co)He(S)?l.framebufferTexture2DMultisampleEXT(t.FRAMEBUFFER,t.DEPTH_STENCIL_ATTACHMENT,t.TEXTURE_2D,Y,0,ie):t.framebufferTexture2D(t.FRAMEBUFFER,t.DEPTH_STENCIL_ATTACHMENT,t.TEXTURE_2D,Y,0);else throw new Error("Unknown depthTexture format")}function Ee(w){const S=i.get(w),V=w.isWebGLCubeRenderTarget===!0;if(w.depthTexture&&!S.__autoAllocateDepthBuffer){if(V)throw new Error("target.depthTexture not supported in Cube render targets");$e(S.__webglFramebuffer,w)}else if(V){S.__webglDepthbuffer=[];for(let Y=0;Y<6;Y++)n.bindFramebuffer(t.FRAMEBUFFER,S.__webglFramebuffer[Y]),S.__webglDepthbuffer[Y]=t.createRenderbuffer(),ge(S.__webglDepthbuffer[Y],w,!1)}else n.bindFramebuffer(t.FRAMEBUFFER,S.__webglFramebuffer),S.__webglDepthbuffer=t.createRenderbuffer(),ge(S.__webglDepthbuffer,w,!1);n.bindFramebuffer(t.FRAMEBUFFER,null)}function U(w,S,V){const Y=i.get(w);S!==void 0&&ye(Y.__webglFramebuffer,w,w.texture,t.COLOR_ATTACHMENT0,t.TEXTURE_2D,0),V!==void 0&&Ee(w)}function xt(w){const S=w.texture,V=i.get(w),Y=i.get(S);w.addEventListener("dispose",j);const ie=w.textures,ee=w.isWebGLCubeRenderTarget===!0,Ie=ie.length>1,Pe=c(w)||a;if(Ie||(Y.__webglTexture===void 0&&(Y.__webglTexture=t.createTexture()),Y.__version=S.version,s.memory.textures++),ee){V.__webglFramebuffer=[];for(let ae=0;ae<6;ae++)if(a&&S.mipmaps&&S.mipmaps.length>0){V.__webglFramebuffer[ae]=[];for(let fe=0;fe<S.mipmaps.length;fe++)V.__webglFramebuffer[ae][fe]=t.createFramebuffer()}else V.__webglFramebuffer[ae]=t.createFramebuffer()}else{if(a&&S.mipmaps&&S.mipmaps.length>0){V.__webglFramebuffer=[];for(let ae=0;ae<S.mipmaps.length;ae++)V.__webglFramebuffer[ae]=t.createFramebuffer()}else V.__webglFramebuffer=t.createFramebuffer();if(Ie)if(r.drawBuffers)for(let ae=0,fe=ie.length;ae<fe;ae++){const Fe=i.get(ie[ae]);Fe.__webglTexture===void 0&&(Fe.__webglTexture=t.createTexture(),s.memory.textures++)}else console.warn("THREE.WebGLRenderer: WebGLMultipleRenderTargets can only be used with WebGL2 or WEBGL_draw_buffers extension.");if(a&&w.samples>0&&He(w)===!1){V.__webglMultisampledFramebuffer=t.createFramebuffer(),V.__webglColorRenderbuffer=[],n.bindFramebuffer(t.FRAMEBUFFER,V.__webglMultisampledFramebuffer);for(let ae=0;ae<ie.length;ae++){const fe=ie[ae];V.__webglColorRenderbuffer[ae]=t.createRenderbuffer(),t.bindRenderbuffer(t.RENDERBUFFER,V.__webglColorRenderbuffer[ae]);const Fe=o.convert(fe.format,fe.colorSpace),re=o.convert(fe.type),mt=R(fe.internalFormat,Fe,re,fe.colorSpace,w.isXRRenderTarget===!0),Ge=Ae(w);t.renderbufferStorageMultisample(t.RENDERBUFFER,Ge,mt,w.width,w.height),t.framebufferRenderbuffer(t.FRAMEBUFFER,t.COLOR_ATTACHMENT0+ae,t.RENDERBUFFER,V.__webglColorRenderbuffer[ae])}t.bindRenderbuffer(t.RENDERBUFFER,null),w.depthBuffer&&(V.__webglDepthRenderbuffer=t.createRenderbuffer(),ge(V.__webglDepthRenderbuffer,w,!0)),n.bindFramebuffer(t.FRAMEBUFFER,null)}}if(ee){n.bindTexture(t.TEXTURE_CUBE_MAP,Y.__webglTexture),O(t.TEXTURE_CUBE_MAP,S,Pe);for(let ae=0;ae<6;ae++)if(a&&S.mipmaps&&S.mipmaps.length>0)for(let fe=0;fe<S.mipmaps.length;fe++)ye(V.__webglFramebuffer[ae][fe],w,S,t.COLOR_ATTACHMENT0,t.TEXTURE_CUBE_MAP_POSITIVE_X+ae,fe);else ye(V.__webglFramebuffer[ae],w,S,t.COLOR_ATTACHMENT0,t.TEXTURE_CUBE_MAP_POSITIVE_X+ae,0);g(S,Pe)&&E(t.TEXTURE_CUBE_MAP),n.unbindTexture()}else if(Ie){for(let ae=0,fe=ie.length;ae<fe;ae++){const Fe=ie[ae],re=i.get(Fe);n.bindTexture(t.TEXTURE_2D,re.__webglTexture),O(t.TEXTURE_2D,Fe,Pe),ye(V.__webglFramebuffer,w,Fe,t.COLOR_ATTACHMENT0+ae,t.TEXTURE_2D,0),g(Fe,Pe)&&E(t.TEXTURE_2D)}n.unbindTexture()}else{let ae=t.TEXTURE_2D;if((w.isWebGL3DRenderTarget||w.isWebGLArrayRenderTarget)&&(a?ae=w.isWebGL3DRenderTarget?t.TEXTURE_3D:t.TEXTURE_2D_ARRAY:console.error("THREE.WebGLTextures: THREE.Data3DTexture and THREE.DataArrayTexture only supported with WebGL2.")),n.bindTexture(ae,Y.__webglTexture),O(ae,S,Pe),a&&S.mipmaps&&S.mipmaps.length>0)for(let fe=0;fe<S.mipmaps.length;fe++)ye(V.__webglFramebuffer[fe],w,S,t.COLOR_ATTACHMENT0,ae,fe);else ye(V.__webglFramebuffer,w,S,t.COLOR_ATTACHMENT0,ae,0);g(S,Pe)&&E(ae),n.unbindTexture()}w.depthBuffer&&Ee(w)}function Me(w){const S=c(w)||a,V=w.textures;for(let Y=0,ie=V.length;Y<ie;Y++){const ee=V[Y];if(g(ee,S)){const Ie=w.isWebGLCubeRenderTarget?t.TEXTURE_CUBE_MAP:t.TEXTURE_2D,Pe=i.get(ee).__webglTexture;n.bindTexture(Ie,Pe),E(Ie),n.unbindTexture()}}}function Ue(w){if(a&&w.samples>0&&He(w)===!1){const S=w.textures,V=w.width,Y=w.height;let ie=t.COLOR_BUFFER_BIT;const ee=[],Ie=w.stencilBuffer?t.DEPTH_STENCIL_ATTACHMENT:t.DEPTH_ATTACHMENT,Pe=i.get(w),ae=S.length>1;if(ae)for(let fe=0;fe<S.length;fe++)n.bindFramebuffer(t.FRAMEBUFFER,Pe.__webglMultisampledFramebuffer),t.framebufferRenderbuffer(t.FRAMEBUFFER,t.COLOR_ATTACHMENT0+fe,t.RENDERBUFFER,null),n.bindFramebuffer(t.FRAMEBUFFER,Pe.__webglFramebuffer),t.framebufferTexture2D(t.DRAW_FRAMEBUFFER,t.COLOR_ATTACHMENT0+fe,t.TEXTURE_2D,null,0);n.bindFramebuffer(t.READ_FRAMEBUFFER,Pe.__webglMultisampledFramebuffer),n.bindFramebuffer(t.DRAW_FRAMEBUFFER,Pe.__webglFramebuffer);for(let fe=0;fe<S.length;fe++){ee.push(t.COLOR_ATTACHMENT0+fe),w.depthBuffer&&ee.push(Ie);const Fe=Pe.__ignoreDepthValues!==void 0?Pe.__ignoreDepthValues:!1;if(Fe===!1&&(w.depthBuffer&&(ie|=t.DEPTH_BUFFER_BIT),w.stencilBuffer&&(ie|=t.STENCIL_BUFFER_BIT)),ae&&t.framebufferRenderbuffer(t.READ_FRAMEBUFFER,t.COLOR_ATTACHMENT0,t.RENDERBUFFER,Pe.__webglColorRenderbuffer[fe]),Fe===!0&&(t.invalidateFramebuffer(t.READ_FRAMEBUFFER,[Ie]),t.invalidateFramebuffer(t.DRAW_FRAMEBUFFER,[Ie])),ae){const re=i.get(S[fe]).__webglTexture;t.framebufferTexture2D(t.DRAW_FRAMEBUFFER,t.COLOR_ATTACHMENT0,t.TEXTURE_2D,re,0)}t.blitFramebuffer(0,0,V,Y,0,0,V,Y,ie,t.NEAREST),u&&t.invalidateFramebuffer(t.READ_FRAMEBUFFER,ee)}if(n.bindFramebuffer(t.READ_FRAMEBUFFER,null),n.bindFramebuffer(t.DRAW_FRAMEBUFFER,null),ae)for(let fe=0;fe<S.length;fe++){n.bindFramebuffer(t.FRAMEBUFFER,Pe.__webglMultisampledFramebuffer),t.framebufferRenderbuffer(t.FRAMEBUFFER,t.COLOR_ATTACHMENT0+fe,t.RENDERBUFFER,Pe.__webglColorRenderbuffer[fe]);const Fe=i.get(S[fe]).__webglTexture;n.bindFramebuffer(t.FRAMEBUFFER,Pe.__webglFramebuffer),t.framebufferTexture2D(t.DRAW_FRAMEBUFFER,t.COLOR_ATTACHMENT0+fe,t.TEXTURE_2D,Fe,0)}n.bindFramebuffer(t.DRAW_FRAMEBUFFER,Pe.__webglMultisampledFramebuffer)}}function Ae(w){return Math.min(r.maxSamples,w.samples)}function He(w){const S=i.get(w);return a&&w.samples>0&&e.has("WEBGL_multisampled_render_to_texture")===!0&&S.__useRenderToTexture!==!1}function Se(w){const S=s.render.frame;d.get(w)!==S&&(d.set(w,S),w.update())}function he(w,S){const V=w.colorSpace,Y=w.format,ie=w.type;return w.isCompressedTexture===!0||w.isVideoTexture===!0||w.format===nf||V!==Qi&&V!==Pi&&(Qe.getTransfer(V)===it?a===!1?e.has("EXT_sRGB")===!0&&Y===In?(w.format=nf,w.minFilter=Kt,w.generateMipmaps=!1):S=Wv.sRGBToLinear(S):(Y!==In||ie!==Wi)&&console.warn("THREE.WebGLTextures: sRGB encoded textures have to use RGBAFormat and UnsignedByteType."):console.error("THREE.WebGLTextures: Unsupported texture color space:",V)),S}function qe(w){return typeof HTMLImageElement<"u"&&w instanceof HTMLImageElement?(f.width=w.naturalWidth||w.width,f.height=w.naturalHeight||w.height):typeof VideoFrame<"u"&&w instanceof VideoFrame?(f.width=w.displayWidth,f.height=w.displayHeight):(f.width=w.width,f.height=w.height),f}this.allocateTextureUnit=X,this.resetTextureUnits=b,this.setTexture2D=$,this.setTexture2DArray=P,this.setTexture3D=I,this.setTextureCube=H,this.rebindTextures=U,this.setupRenderTarget=xt,this.updateRenderTargetMipmap=Me,this.updateMultisampleRenderTarget=Ue,this.setupDepthRenderbuffer=Ee,this.setupFrameBufferTexture=ye,this.useMultisampledRTT=He}function Gw(t,e,n){const i=n.isWebGL2;function r(o,s=Pi){let a;const l=Qe.getTransfer(s);if(o===Wi)return t.UNSIGNED_BYTE;if(o===Fv)return t.UNSIGNED_SHORT_4_4_4_4;if(o===Ov)return t.UNSIGNED_SHORT_5_5_5_1;if(o===xS)return t.BYTE;if(o===yS)return t.SHORT;if(o===od)return t.UNSIGNED_SHORT;if(o===Iv)return t.INT;if(o===Ni)return t.UNSIGNED_INT;if(o===oi)return t.FLOAT;if(o===Ls)return i?t.HALF_FLOAT:(a=e.get("OES_texture_half_float"),a!==null?a.HALF_FLOAT_OES:null);if(o===SS)return t.ALPHA;if(o===In)return t.RGBA;if(o===ES)return t.LUMINANCE;if(o===MS)return t.LUMINANCE_ALPHA;if(o===Sr)return t.DEPTH_COMPONENT;if(o===Co)return t.DEPTH_STENCIL;if(o===nf)return a=e.get("EXT_sRGB"),a!==null?a.SRGB_ALPHA_EXT:null;if(o===TS)return t.RED;if(o===kv)return t.RED_INTEGER;if(o===wS)return t.RG;if(o===zv)return t.RG_INTEGER;if(o===Bv)return t.RGBA_INTEGER;if(o===Tu||o===wu||o===Au||o===Cu)if(l===it)if(a=e.get("WEBGL_compressed_texture_s3tc_srgb"),a!==null){if(o===Tu)return a.COMPRESSED_SRGB_S3TC_DXT1_EXT;if(o===wu)return a.COMPRESSED_SRGB_ALPHA_S3TC_DXT1_EXT;if(o===Au)return a.COMPRESSED_SRGB_ALPHA_S3TC_DXT3_EXT;if(o===Cu)return a.COMPRESSED_SRGB_ALPHA_S3TC_DXT5_EXT}else return null;else if(a=e.get("WEBGL_compressed_texture_s3tc"),a!==null){if(o===Tu)return a.COMPRESSED_RGB_S3TC_DXT1_EXT;if(o===wu)return a.COMPRESSED_RGBA_S3TC_DXT1_EXT;if(o===Au)return a.COMPRESSED_RGBA_S3TC_DXT3_EXT;if(o===Cu)return a.COMPRESSED_RGBA_S3TC_DXT5_EXT}else return null;if(o===kh||o===zh||o===Bh||o===Hh)if(a=e.get("WEBGL_compressed_texture_pvrtc"),a!==null){if(o===kh)return a.COMPRESSED_RGB_PVRTC_4BPPV1_IMG;if(o===zh)return a.COMPRESSED_RGB_PVRTC_2BPPV1_IMG;if(o===Bh)return a.COMPRESSED_RGBA_PVRTC_4BPPV1_IMG;if(o===Hh)return a.COMPRESSED_RGBA_PVRTC_2BPPV1_IMG}else return null;if(o===Hv)return a=e.get("WEBGL_compressed_texture_etc1"),a!==null?a.COMPRESSED_RGB_ETC1_WEBGL:null;if(o===Gh||o===Vh)if(a=e.get("WEBGL_compressed_texture_etc"),a!==null){if(o===Gh)return l===it?a.COMPRESSED_SRGB8_ETC2:a.COMPRESSED_RGB8_ETC2;if(o===Vh)return l===it?a.COMPRESSED_SRGB8_ALPHA8_ETC2_EAC:a.COMPRESSED_RGBA8_ETC2_EAC}else return null;if(o===Wh||o===Xh||o===jh||o===Yh||o===$h||o===qh||o===Kh||o===Zh||o===Qh||o===Jh||o===ep||o===tp||o===np||o===ip)if(a=e.get("WEBGL_compressed_texture_astc"),a!==null){if(o===Wh)return l===it?a.COMPRESSED_SRGB8_ALPHA8_ASTC_4x4_KHR:a.COMPRESSED_RGBA_ASTC_4x4_KHR;if(o===Xh)return l===it?a.COMPRESSED_SRGB8_ALPHA8_ASTC_5x4_KHR:a.COMPRESSED_RGBA_ASTC_5x4_KHR;if(o===jh)return l===it?a.COMPRESSED_SRGB8_ALPHA8_ASTC_5x5_KHR:a.COMPRESSED_RGBA_ASTC_5x5_KHR;if(o===Yh)return l===it?a.COMPRESSED_SRGB8_ALPHA8_ASTC_6x5_KHR:a.COMPRESSED_RGBA_ASTC_6x5_KHR;if(o===$h)return l===it?a.COMPRESSED_SRGB8_ALPHA8_ASTC_6x6_KHR:a.COMPRESSED_RGBA_ASTC_6x6_KHR;if(o===qh)return l===it?a.COMPRESSED_SRGB8_ALPHA8_ASTC_8x5_KHR:a.COMPRESSED_RGBA_ASTC_8x5_KHR;if(o===Kh)return l===it?a.COMPRESSED_SRGB8_ALPHA8_ASTC_8x6_KHR:a.COMPRESSED_RGBA_ASTC_8x6_KHR;if(o===Zh)return l===it?a.COMPRESSED_SRGB8_ALPHA8_ASTC_8x8_KHR:a.COMPRESSED_RGBA_ASTC_8x8_KHR;if(o===Qh)return l===it?a.COMPRESSED_SRGB8_ALPHA8_ASTC_10x5_KHR:a.COMPRESSED_RGBA_ASTC_10x5_KHR;if(o===Jh)return l===it?a.COMPRESSED_SRGB8_ALPHA8_ASTC_10x6_KHR:a.COMPRESSED_RGBA_ASTC_10x6_KHR;if(o===ep)return l===it?a.COMPRESSED_SRGB8_ALPHA8_ASTC_10x8_KHR:a.COMPRESSED_RGBA_ASTC_10x8_KHR;if(o===tp)return l===it?a.COMPRESSED_SRGB8_ALPHA8_ASTC_10x10_KHR:a.COMPRESSED_RGBA_ASTC_10x10_KHR;if(o===np)return l===it?a.COMPRESSED_SRGB8_ALPHA8_ASTC_12x10_KHR:a.COMPRESSED_RGBA_ASTC_12x10_KHR;if(o===ip)return l===it?a.COMPRESSED_SRGB8_ALPHA8_ASTC_12x12_KHR:a.COMPRESSED_RGBA_ASTC_12x12_KHR}else return null;if(o===Ru||o===rp||o===op)if(a=e.get("EXT_texture_compression_bptc"),a!==null){if(o===Ru)return l===it?a.COMPRESSED_SRGB_ALPHA_BPTC_UNORM_EXT:a.COMPRESSED_RGBA_BPTC_UNORM_EXT;if(o===rp)return a.COMPRESSED_RGB_BPTC_SIGNED_FLOAT_EXT;if(o===op)return a.COMPRESSED_RGB_BPTC_UNSIGNED_FLOAT_EXT}else return null;if(o===AS||o===sp||o===ap||o===lp)if(a=e.get("EXT_texture_compression_rgtc"),a!==null){if(o===Ru)return a.COMPRESSED_RED_RGTC1_EXT;if(o===sp)return a.COMPRESSED_SIGNED_RED_RGTC1_EXT;if(o===ap)return a.COMPRESSED_RED_GREEN_RGTC2_EXT;if(o===lp)return a.COMPRESSED_SIGNED_RED_GREEN_RGTC2_EXT}else return null;return o===yr?i?t.UNSIGNED_INT_24_8:(a=e.get("WEBGL_depth_texture"),a!==null?a.UNSIGNED_INT_24_8_WEBGL:null):t[o]!==void 0?t[o]:null}return{convert:r}}class Vw extends Sn{constructor(e=[]){super(),this.isArrayCamera=!0,this.cameras=e}}class Pa extends sn{constructor(){super(),this.isGroup=!0,this.type="Group"}}const Ww={type:"move"};class tc{constructor(){this._targetRay=null,this._grip=null,this._hand=null}getHandSpace(){return this._hand===null&&(this._hand=new Pa,this._hand.matrixAutoUpdate=!1,this._hand.visible=!1,this._hand.joints={},this._hand.inputState={pinching:!1}),this._hand}getTargetRaySpace(){return this._targetRay===null&&(this._targetRay=new Pa,this._targetRay.matrixAutoUpdate=!1,this._targetRay.visible=!1,this._targetRay.hasLinearVelocity=!1,this._targetRay.linearVelocity=new z,this._targetRay.hasAngularVelocity=!1,this._targetRay.angularVelocity=new z),this._targetRay}getGripSpace(){return this._grip===null&&(this._grip=new Pa,this._grip.matrixAutoUpdate=!1,this._grip.visible=!1,this._grip.hasLinearVelocity=!1,this._grip.linearVelocity=new z,this._grip.hasAngularVelocity=!1,this._grip.angularVelocity=new z),this._grip}dispatchEvent(e){return this._targetRay!==null&&this._targetRay.dispatchEvent(e),this._grip!==null&&this._grip.dispatchEvent(e),this._hand!==null&&this._hand.dispatchEvent(e),this}connect(e){if(e&&e.hand){const n=this._hand;if(n)for(const i of e.hand.values())this._getHandJoint(n,i)}return this.dispatchEvent({type:"connected",data:e}),this}disconnect(e){return this.dispatchEvent({type:"disconnected",data:e}),this._targetRay!==null&&(this._targetRay.visible=!1),this._grip!==null&&(this._grip.visible=!1),this._hand!==null&&(this._hand.visible=!1),this}update(e,n,i){let r=null,o=null,s=null;const a=this._targetRay,l=this._grip,u=this._hand;if(e&&n.session.visibilityState!=="visible-blurred"){if(u&&e.hand){s=!0;for(const x of e.hand.values()){const p=n.getJointPose(x,i),c=this._getHandJoint(u,x);p!==null&&(c.matrix.fromArray(p.transform.matrix),c.matrix.decompose(c.position,c.rotation,c.scale),c.matrixWorldNeedsUpdate=!0,c.jointRadius=p.radius),c.visible=p!==null}const f=u.joints["index-finger-tip"],d=u.joints["thumb-tip"],h=f.position.distanceTo(d.position),m=.02,_=.005;u.inputState.pinching&&h>m+_?(u.inputState.pinching=!1,this.dispatchEvent({type:"pinchend",handedness:e.handedness,target:this})):!u.inputState.pinching&&h<=m-_&&(u.inputState.pinching=!0,this.dispatchEvent({type:"pinchstart",handedness:e.handedness,target:this}))}else l!==null&&e.gripSpace&&(o=n.getPose(e.gripSpace,i),o!==null&&(l.matrix.fromArray(o.transform.matrix),l.matrix.decompose(l.position,l.rotation,l.scale),l.matrixWorldNeedsUpdate=!0,o.linearVelocity?(l.hasLinearVelocity=!0,l.linearVelocity.copy(o.linearVelocity)):l.hasLinearVelocity=!1,o.angularVelocity?(l.hasAngularVelocity=!0,l.angularVelocity.copy(o.angularVelocity)):l.hasAngularVelocity=!1));a!==null&&(r=n.getPose(e.targetRaySpace,i),r===null&&o!==null&&(r=o),r!==null&&(a.matrix.fromArray(r.transform.matrix),a.matrix.decompose(a.position,a.rotation,a.scale),a.matrixWorldNeedsUpdate=!0,r.linearVelocity?(a.hasLinearVelocity=!0,a.linearVelocity.copy(r.linearVelocity)):a.hasLinearVelocity=!1,r.angularVelocity?(a.hasAngularVelocity=!0,a.angularVelocity.copy(r.angularVelocity)):a.hasAngularVelocity=!1,this.dispatchEvent(Ww)))}return a!==null&&(a.visible=r!==null),l!==null&&(l.visible=o!==null),u!==null&&(u.visible=s!==null),this}_getHandJoint(e,n){if(e.joints[n.jointName]===void 0){const i=new Pa;i.matrixAutoUpdate=!1,i.visible=!1,e.joints[n.jointName]=i,e.add(i)}return e.joints[n.jointName]}}const Xw=`
void main() {
...
}`;class Yw{constructor(){this.texture=null,this.mesh=null,this.depthNear=0,this.depthFar=0}init(e,n,i){if(this.texture===null){const r=new on,o=e.properties.get(r);o.__webglTexture=n.texture,(n.depthNear!=i.depthNear||n.depthFar!=i.depthFar)&&(this.depthNear=n.depthNear,this.depthFar=n.depthFar),this.texture=r}}render(e,n){if(this.texture!==null){if(this.mesh===null){const i=n.cameras[0].viewport,r=new $i({extensions:{fragDepth:!0},vertexShader:Xw,fragmentShader:jw,uniforms:{depthColor:{value:this.texture},depthWidth:{value:i.z},depthHeight:{value:i.w}}});this.mesh=new ui(new Wl(20,20),r)}e.render(this.mesh,n)}}reset(){this.texture=null,this.mesh=null}}class $w extends No{constructor(e,n){super();const i=this;let r=null,o=1,s=null,a="local-floor",l=1,u=null,f=null,d=null,h=null,m=null,_=null;const x=new Yw,p=n.getContextAttributes();let c=null,v=null;const g=[],E=[],R=new Ye;let A=null;const T=new Sn;T.layers.enable(1),T.viewport=new Lt;const L=new Sn;L.layers.enable(2),L.viewport=new Lt;const j=[T,L],y=new Vw;y.layers.enable(1),y.layers.enable(2);let C=null,J=null;this.cameraAutoUpdate=!0,this.enabled=!1,this.isPresenting=!1,this.getController=function(O){let K=g[O];return K===void 0&&(K=new tc,g[O]=K),K.getTargetRaySpace()},this.getControllerGrip=function(O){let K=g[O];return K===void 0&&(K=new tc,g[O]=K),K.getGripSpace()},this.getHand=function(O){let K=g[O];return K===void 0&&(K=new tc,g[O]=K),K.getHandSpace()};function Q(O){const K=E.indexOf(O.inputSource);if(K===-1)return;const le=g[K];le!==void 0&&(le.update(O.inputSource,O.frame,u||s),le.dispatchEvent({type:O.type,data:O.inputSource}))}function b(){r.removeEventListener("select",Q),r.removeEventListener("selectstart",Q),r.removeEventListener("selectend",Q),r.removeEventListener("squeeze",Q),r.removeEventListener("squeezestart",Q),r.removeEventListener("squeezeend",Q),r.removeEventListener("end",b),r.removeEventListener("inputsourceschange",X);for(let O=0;O<g.length;O++){const K=E[O];K!==null&&(E[O]=null,g[O].disconnect(K))}C=null,J=null,x.reset(),e.setRenderTarget(c),m=null,h=null,d=null,r=null,v=null,Ce.stop(),i.isPresenting=!1,e.setPixelRatio(A),e.setSize(R.width,R.height,!1),i.dispatchEvent({type:"sessionend"})}this.setFramebufferScaleFactor=function(O){o=O,i.isPresenting===!0&&console.warn("THREE.WebXRManager: Cannot change framebuffer scale while presenting.")},this.setReferenceSpaceType=function(O){a=O,i.isPresenting===!0&&console.warn("THREE.WebXRManager: Cannot change reference space type while presenting.")},this.getReferenceSpace=function(){return u||s},this.setReferenceSpace=function(O){u=O},this.getBaseLayer=function(){return h!==null?h:m},this.getBinding=function(){return d},this.getFrame=function(){return _},this.getSession=function(){return r},this.setSession=async function(O){if(r=O,r!==null){if(c=e.getRenderTarget(),r.addEventListener("select",Q),r.addEventListener("selectstart",Q),r.addEventListener("selectend",Q),r.addEventListener("squeeze",Q),r.addEventListener("squeezestart",Q),r.addEventListener("squeezeend",Q),r.addEventListener("end",b),r.addEventListener("inputsourceschange",X),p.xrCompatible!==!0&&await n.makeXRCompatible(),A=e.getPixelRatio(),e.getSize(R),r.renderState.layers===void 0||e.capabilities.isWebGL2===!1){const K={antialias:r.renderState.layers===void 0?p.antialias:!0,alpha:!0,depth:p.depth,stencil:p.stencil,framebufferScaleFactor:o};m=new XRWebGLLayer(r,n,K),r.updateRenderState({baseLayer:m}),e.setPixelRatio(1),e.setSize(m.framebufferWidth,m.framebufferHeight,!1),v=new Rr(m.framebufferWidth,m.framebufferHeight,{format:In,type:Wi,colorSpace:e.outputColorSpace,stencilBuffer:p.stencil})}else{let K=null,le=null,Te=null;p.depth&&(Te=p.stencil?n.DEPTH24_STENCIL8:n.DEPTH_COMPONENT24,K=p.stencil?Co:Sr,le=p.stencil?yr:Ni);const ye={colorFormat:n.RGBA8,depthFormat:Te,scaleFactor:o};d=new XRWebGLBinding(r,n),h=d.createProjectionLayer(ye),r.updateRenderState({layers:[h]}),e.setPixelRatio(1),e.setSize(h.textureWidth,h.textureHeight,!1),v=new Rr(h.textureWidth,h.textureHeight,{format:In,type:Wi,depthTexture:new r_(h.textureWidth,h.textureHeight,le,void 0,void 0,void 0,void 0,void 0,void 0,K),stencilBuffer:p.stencil,colorSpace:e.outputColorSpace,samples:p.antialias?4:0});const ge=e.properties.get(v);ge.__ignoreDepthValues=h.ignoreDepthValues}v.isXRRenderTarget=!0,this.setFoveation(l),u=null,s=await r.requestReferenceSpace(a),Ce.setContext(r),Ce.start(),i.isPresenting=!0,i.dispatchEvent({type:"sessionstart"})}},this.getEnvironmentBlendMode=function(){if(r!==null)return r.environmentBlendMode};function X(O){for(let K=0;K<O.removed.length;K++){const le=O.removed[K],Te=E.indexOf(le);Te>=0&&(E[Te]=null,g[Te].disconnect(le))}for(let K=0;K<O.added.length;K++){const le=O.added[K];let Te=E.indexOf(le);if(Te===-1){for(let ge=0;ge<g.length;ge++)if(ge>=E.length){E.push(le),Te=ge;break}else if(E[ge]===null){E[ge]=le,Te=ge;break}if(Te===-1)break}const ye=g[Te];ye&&ye.connect(le)}}const W=new z,$=new z;function P(O,K,le){W.setFromMatrixPosition(K.matrixWorld),$.setFromMatrixPosition(le.matrixWorld);const Te=W.distanceTo($),ye=K.projectionMatrix.elements,ge=le.projectionMatrix.elements,$e=ye[14]/(ye[10]-1),Ee=ye[14]/(ye[10]+1),U=(ye[9]+1)/ye[5],xt=(ye[9]-1)/ye[5],Me=(ye[8]-1)/ye[0],Ue=(ge[8]+1)/ge[0],Ae=$e*Me,He=$e*Ue,Se=Te/(-Me+Ue),he=Se*-Me;K.matrixWorld.decompose(O.position,O.quaternion,O.scale),O.translateX(he),O.translateZ(Se),O.matrixWorld.compose(O.position,O.quaternion,O.scale),O.matrixWorldInverse.copy(O.matrixWorld).invert();const qe=$e+Se,w=Ee+Se,S=Ae-he,V=He+(Te-he),Y=U*Ee/w*qe,ie=xt*Ee/w*qe;O.projectionMatrix.makePerspective(S,V,Y,ie,qe,w),O.projectionMatrixInverse.copy(O.projectionMatrix).invert()}function I(O,K){K===null?O.matrixWorld.copy(O.matrix):O.matrixWorld.multiplyMatrices(K.matrixWorld,O.matrix),O.matrixWorldInverse.copy(O.matrixWorld).invert()}this.updateCamera=function(O){if(r===null)return;x.texture!==null&&(O.near=x.depthNear,O.far=x.depthFar),y.near=L.near=T.near=O.near,y.far=L.far=T.far=O.far,(C!==y.near||J!==y.far)&&(r.updateRenderState({depthNear:y.near,depthFar:y.far}),C=y.near,J=y.far,T.near=C,T.far=J,L.near=C,L.far=J,T.updateProjectionMatrix(),L.updateProjectionMatrix(),O.updateProjectionMatrix());const K=O.parent,le=y.cameras;I(y,K);for(let Te=0;Te<le.length;Te++)I(le[Te],K);le.length===2?P(y,T,L):y.projectionMatrix.copy(T.projectionMatrix),H(O,y,K)};function H(O,K,le){le===null?O.matrix.copy(K.matrixWorld):(O.matrix.copy(le.matrixWorld),O.matrix.invert(),O.matrix.multiply(K.matrixWorld)),O.matrix.decompose(O.position,O.quaternion,O.scale),O.updateMatrixWorld(!0),O.projectionMatrix.copy(K.projectionMatrix),O.projectionMatrixInverse.copy(K.projectionMatrixInverse),O.isPerspectiveCamera&&(O.fov=rf*2*Math.atan(1/O.projectionMatrix.elements[5]),O.zoom=1)}this.getCamera=function(){return y},this.getFoveation=function(){if(!(h===null&&m===null))return l},this.setFoveation=function(O){l=O,h!==null&&(h.fixedFoveation=O),m!==null&&m.fixedFoveation!==void 0&&(m.fixedFoveation=O)},this.hasDepthSensing=function(){return x.texture!==null};let q=null;function ne(O,K){if(f=K.getViewerPose(u||s),_=K,f!==null){const le=f.views;m!==null&&(e.setRenderTargetFramebuffer(v,m.framebuffer),e.setRenderTarget(v));let Te=!1;le.length!==y.cameras.length&&(y.cameras.length=0,Te=!0);for(let ge=0;ge<le.length;ge++){const $e=le[ge];let Ee=null;if(m!==null)Ee=m.getViewport($e);else{const xt=d.getViewSubImage(h,$e);Ee=xt.viewport,ge===0&&(e.setRenderTargetTextures(v,xt.colorTexture,h.ignoreDepthValues?void 0:xt.depthStencilTexture),e.setRenderTarget(v))}let U=j[ge];U===void 0&&(U=new Sn,U.layers.enable(ge),U.viewport=new Lt,j[ge]=U),U.matrix.fromArray($e.transform.matrix),U.matrix.decompose(U.position,U.quaternion,U.scale),U.projectionMatrix.fromArray($e.projectionMatrix),U.projectionMatrixInverse.copy(U.projectionMatrix).invert(),U.viewport.set(Ee.x,Ee.y,Ee.width,Ee.height),ge===0&&(y.matrix.copy(U.matrix),y.matrix.decompose(y.position,y.quaternion,y.scale)),Te===!0&&y.cameras.push(U)}const ye=r.enabledFeatures;if(ye&&ye.includes("depth-sensing")){const ge=d.getDepthInformation(le[0]);ge&&ge.isValid&&ge.texture&&x.init(e,ge,r.renderState)}}for(let le=0;le<g.length;le++){const Te=E[le],ye=g[le];Te!==null&&ye!==void 0&&ye.update(Te,K,u||s)}x.render(e,y),q&&q(O,K),K.detectedPlanes&&i.dispatchEvent({type:"planesdetected",data:K}),_=null}const Ce=new i_;Ce.setAnimationLoop(ne),this.setAnimationLoop=function(O){q=O},this.dispose=function(){}}}const sr=new mi,qw=new _t;function Kw(t,e){function n(p,c){p.matrixAutoUpdate===!0&&p.updateMatrix(),c.value.copy(p.matrix)}function i(p,c){c.color.getRGB(p.fogColor.value,Jv(t)),c.isFog?(p.fogNear.value=c.near,p.fogFar.value=c.far):c.isFogExp2&&(p.fogDensity.value=c.density)}function r(p,c,v,g,E){c.isMeshBasicMaterial||c.isMeshLambertMaterial?o(p,c):c.isMeshToonMaterial?(o(p,c),d(p,c)):c.isMeshPhongMaterial?(o(p,c),f(p,c)):c.isMeshStandardMaterial?(o(p,c),h(p,c),c.isMeshPhysicalMaterial&&m(p,c,E)):c.isMeshMatcapMaterial?(o(p,c),_(p,c)):c.isMeshDepthMaterial?o(p,c):c.isMeshDistanceMaterial?(o(p,c),x(p,c)):c.isMeshNormalMaterial?o(p,c):c.isLineBasicMaterial?(s(p,c),c.isLineDashedMaterial&&a(p,c)):c.isPointsMaterial?l(p,c,v,g):c.isSpriteMaterial?u(p,c):c.isShadowMaterial?(p.color.value.copy(c.color),p.opacity.value=c.opacity):c.isShaderMaterial&&(c.uniformsNeedUpdate=!1)}function o(p,c){p.opacity.value=c.opacity,c.color&&p.diffuse.value.copy(c.color),c.emissive&&p.emissive.value.copy(c.emissive).multiplyScalar(c.emissiveIntensity),c.map&&(p.map.value=c.map,n(c.map,p.mapTransform)),c.alphaMap&&(p.alphaMap.value=c.alphaMap,n(c.alphaMap,p.alphaMapTransform)),c.bumpMap&&(p.bumpMap.value=c.bumpMap,n(c.bumpMap,p.bumpMapTransform),p.bumpScale.value=c.bumpScale,c.side===rn&&(p.bumpScale.value*=-1)),c.normalMap&&(p.normalMap.value=c.normalMap,n(c.normalMap,p.normalMapTransform),p.normalScale.value.copy(c.normalScale),c.side===rn&&p.normalScale.value.negate()),c.displacementMap&&(p.displacementMap.value=c.displacementMap,n(c.displacementMap,p.displacementMapTransform),p.displacementScale.value=c.displacementScale,p.displacementBias.value=c.displacementBias),c.emissiveMap&&(p.emissiveMap.value=c.emissiveMap,n(c.emissiveMap,p.emissiveMapTransform)),c.specularMap&&(p.specularMap.value=c.specularMap,n(c.specularMap,p.specularMapTransform)),c.alphaTest>0&&(p.alphaTest.value=c.alphaTest);const v=e.get(c),g=v.envMap,E=v.envMapRotation;if(g&&(p.envMap.value=g,sr.copy(E),sr.x*=-1,sr.y*=-1,sr.z*=-1,g.isCubeTexture&&g.isRenderTargetTexture===!1&&(sr.y*=-1,sr.z*=-1),p.envMapRotation.value.setFromMatrix4(qw.makeRotationFromEuler(sr)),p.flipEnvMap.value=g.isCubeTexture&&g.isRenderTargetTexture===!1?-1:1,p.reflectivity.value=c.reflectivity,p.ior.value=c.ior,p.refractionRatio.value=c.refractionRatio),c.lightMap){p.lightMap.value=c.lightMap;const R=t._useLegacyLights===!0?Math.PI:1;p.lightMapIntensity.value=c.lightMapIntensity*R,n(c.lightMap,p.lightMapTransform)}c.aoMap&&(p.aoMap.value=c.aoMap,p.aoMapIntensity.value=c.aoMapIntensity,n(c.aoMap,p.aoMapTransform))}function s(p,c){p.diffuse.value.copy(c.color),p.opacity.value=c.opacity,c.map&&(p.map.value=c.map,n(c.map,p.mapTransform))}function a(p,c){p.dashSize.value=c.dashSize,p.totalSize.value=c.dashSize+c.gapSize,p.scale.value=c.scale}function l(p,c,v,g){p.diffuse.value.copy(c.color),p.opacity.value=c.opacity,p.size.value=c.size*v,p.scale.value=g*.5,c.map&&(p.map.value=c.map,n(c.map,p.uvTransform)),c.alphaMap&&(p.alphaMap.value=c.alphaMap,n(c.alphaMap,p.alphaMapTransform)),c.alphaTest>0&&(p.alphaTest.value=c.alphaTest)}function u(p,c){p.diffuse.value.copy(c.color),p.opacity.value=c.opacity,p.rotation.value=c.rotation,c.map&&(p.map.value=c.map,n(c.map,p.mapTransform)),c.alphaMap&&(p.alphaMap.value=c.alphaMap,n(c.alphaMap,p.alphaMapTransform)),c.alphaTest>0&&(p.alphaTest.value=c.alphaTest)}function f(p,c){p.specular.value.copy(c.specular),p.shininess.value=Math.max(c.shininess,1e-4)}function d(p,c){c.gradientMap&&(p.gradientMap.value=c.gradientMap)}function h(p,c){p.metalness.value=c.metalness,c.metalnessMap&&(p.metalnessMap.value=c.metalnessMap,n(c.metalnessMap,p.metalnessMapTransform)),p.roughness.value=c.roughness,c.roughnessMap&&(p.roughnessMap.value=c.roughnessMap,n(c.roughnessMap,p.roughnessMapTransform)),e.get(c).envMap&&(p.envMapIntensity.value=c.envMapIntensity)}function m(p,c,v){p.ior.value=c.ior,c.sheen>0&&(p.sheenColor.value.copy(c.sheenColor).multiplyScalar(c.sheen),p.sheenRoughness.value=c.sheenRoughness,c.sheenColorMap&&(p.sheenColorMap.value=c.sheenColorMap,n(c.sheenColorMap,p.sheenColorMapTransform)),c.sheenRoughnessMap&&(p.sheenRoughnessMap.value=c.sheenRoughnessMap,n(c.sheenRoughnessMap,p.sheenRoughnessMapTransform))),c.clearcoat>0&&(p.clearcoat.value=c.clearcoat,p.clearcoatRoughness.value=c.clearcoatRoughness,c.clearcoatMap&&(p.clearcoatMap.value=c.clearcoatMap,n(c.clearcoatMap,p.clearcoatMapTransform)),c.clearcoatRoughnessMap&&(p.clearcoatRoughnessMap.value=c.clearcoatRoughnessMap,n(c.clearcoatRoughnessMap,p.clearcoatRoughnessMapTransform)),c.clearcoatNormalMap&&(p.clearcoatNormalMap.value=c.clearcoatNormalMap,n(c.clearcoatNormalMap,p.clearcoatNormalMapTransform),p.clearcoatNormalScale.value.copy(c.clearcoatNormalScale),c.side===rn&&p.clearcoatNormalScale.value.negate())),c.iridescence>0&&(p.iridescence.value=c.iridescence,p.iridescenceIOR.value=c.iridescenceIOR,p.iridescenceThicknessMinimum.value=c.iridescenceThicknessRange[0],p.iridescenceThicknessMaximum.value=c.iridescenceThicknessRange[1],c.iridescenceMap&&(p.iridescenceMap.value=c.iridescenceMap,n(c.iridescenceMap,p.iridescenceMapTransform)),c.iridescenceThicknessMap&&(p.iridescenceThicknessMap.value=c.iridescenceThicknessMap,n(c.iridescenceThicknessMap,p.iridescenceThicknessMapTransform))),c.transmission>0&&(p.transmission.value=c.transmission,p.transmissionSamplerMap.value=v.texture,p.transmissionSamplerSize.value.set(v.width,v.height),c.transmissionMap&&(p.transmissionMap.value=c.transmissionMap,n(c.transmissionMap,p.transmissionMapTransform)),p.thickness.value=c.thickness,c.thicknessMap&&(p.thicknessMap.value=c.thicknessMap,n(c.thicknessMap,p.thicknessMapTransform)),p.attenuationDistance.value=c.attenuationDistance,p.attenuationColor.value.copy(c.attenuationColor)),c.anisotropy>0&&(p.anisotropyVector.value.set(c.anisotropy*Math.cos(c.anisotropyRotation),c.anisotropy*Math.sin(c.anisotropyRotation)),c.anisotropyMap&&(p.anisotropyMap.value=c.anisotropyMap,n(c.anisotropyMap,p.anisotropyMapTransform))),p.specularIntensity.value=c.specularIntensity,p.specularColor.value.copy(c.specularColor),c.specularColorMap&&(p.specularColorMap.value=c.specularColorMap,n(c.specularColorMap,p.specularColorMapTransform)),c.specularIntensityMap&&(p.specularIntensityMap.value=c.specularIntensityMap,n(c.specularIntensityMap,p.specularIntensityMapTransform))}function _(p,c){c.matcap&&(p.matcap.value=c.matcap)}function x(p,c){const v=e.get(c).light;p.referencePosition.value.setFromMatrixPosition(v.matrixWorld),p.nearDistance.value=v.shadow.camera.near,p.farDistance.value=v.shadow.camera.far}return{refreshFogUniforms:i,refreshMaterialUniforms:r}}function Zw(t,e,n,i){let r={},o={},s=[];const a=n.isWebGL2?t.getParameter(t.MAX_UNIFORM_BUFFER_BINDINGS):0;function l(v,g){const E=g.program;i.uniformBlockBinding(v,E)}function u(v,g){let E=r[v.id];E===void 0&&(_(v),E=f(v),r[v.id]=E,v.addEventListener("dispose",p));const R=g.program;i.updateUBOMapping(v,R);const A=e.render.frame;o[v.id]!==A&&(h(v),o[v.id]=A)}function f(v){const g=d();v.__bindingPointIndex=g;const E=t.createBuffer(),R=v.__size,A=v.usage;return t.bindBuffer(t.UNIFORM_BUFFER,E),t.bufferData(t.UNIFORM_BUFFER,R,A),t.bindBuffer(t.UNIFORM_BUFFER,null),t.bindBufferBase(t.UNIFORM_BUFFER,g,E),E}function d(){for(let v=0;v<a;v++)if(s.indexOf(v)===-1)return s.push(v),v;return console.error("THREE.WebGLRenderer: Maximum number of simultaneously usable uniforms groups reached."),0}function h(v){const g=r[v.id],E=v.uniforms,R=v.__cache;t.bindBuffer(t.UNIFORM_BUFFER,g);for(let A=0,T=E.length;A<T;A++){const L=Array.isArray(E[A])?E[A]:[E[A]];for(let j=0,y=L.length;j<y;j++){const C=L[j];if(m(C,A,j,R)===!0){const J=C.__offset,Q=Array.isArray(C.value)?C.value:[C.value];let b=0;for(let X=0;X<Q.length;X++){const W=Q[X],$=x(W);typeof W=="number"||typeof W=="boolean"?(C.__data[0]=W,t.bufferSubData(t.UNIFORM_BUFFER,J+b,C.__data)):W.isMatrix3?(C.__data[0]=W.elements[0],C.__data[1]=W.elements[1],C.__data[2]=W.elements[2],C.__data[3]=0,C.__data[4]=W.elements[3],C.__data[5]=W.elements[4],C.__data[6]=W.elements[5],C.__data[7]=0,C.__data[8]=W.elements[6],C.__data[9]=W.elements[7],C.__data[10]=W.elements[8],C.__data[11]=0):(W.toArray(C.__data,b),b+=$.storage/Float32Array.BYTES_PER_ELEMENT)}t.bufferSubData(t.UNIFORM_BUFFER,J,C.__data)}}}t.bindBuffer(t.UNIFORM_BUFFER,null)}function m(v,g,E,R){const A=v.value,T=g+"_"+E;if(R[T]===void 0)return typeof A=="number"||typeof A=="boolean"?R[T]=A:R[T]=A.clone(),!0;{const L=R[T];if(typeof A=="number"||typeof A=="boolean"){if(L!==A)return R[T]=A,!0}else if(L.equals(A)===!1)return L.copy(A),!0}return!1}function _(v){const g=v.uniforms;let E=0;const R=16;for(let T=0,L=g.length;T<L;T++){const j=Array.isArray(g[T])?g[T]:[g[T]];for(let y=0,C=j.length;y<C;y++){const J=j[y],Q=Array.isArray(J.value)?J.value:[J.value];for(let b=0,X=Q.length;b<X;b++){const W=Q[b],$=x(W),P=E%R;P!==0&&R-P<$.boundary&&(E+=R-P),J.__data=new Float32Array($.storage/Float32Array.BYTES_PER_ELEMENT),J.__offset=E,E+=$.storage}}}const A=E%R;return A>0&&(E+=R-A),v.__size=E,v.__cache={},this}function x(v){const g={boundary:0,storage:0};return typeof v=="number"||typeof v=="boolean"?(g.boundary=4,g.storage=4):v.isVector2?(g.boundary=8,g.storage=8):v.isVector3||v.isColor?(g.boundary=16,g.storage=12):v.isVector4?(g.boundary=16,g.storage=16):v.isMatrix3?(g.boundary=48,g.storage=48):v.isMatrix4?(g.boundary=64,g.storage=64):v.isTexture?console.warn("THREE.WebGLRenderer: Texture samplers can not be part of an uniforms group."):console.warn("THREE.WebGLRenderer: Unsupported uniform value type.",v),g}function p(v){const g=v.target;g.removeEventListener("dispose",p);const E=s.indexOf(g.__bindingPointIndex);s.splice(E,1),t.deleteBuffer(r[g.id]),delete r[g.id],delete o[g.id]}function c(){for(const v in r)t.deleteBuffer(r[v]);s=[],r={},o={}}return{bind:l,update:u,dispose:c}}class c_{constructor(e={}){const{canvas:n=zS(),context:i=null,depth:r=!0,stencil:o=!0,alpha:s=!1,antialias:a=!1,premultipliedAlpha:l=!0,preserveDrawingBuffer:u=!1,powerPreference:f="default",failIfMajorPerformanceCaveat:d=!1}=e;this.isWebGLRenderer=!0;let h;i!==null?h=i.getContextAttributes().alpha:h=s;const m=new Uint32Array(4),_=new Int32Array(4);let x=null,p=null;const c=[],v=[];this.domElement=n,this.debug={checkShaderErrors:!0,onShaderError:null},this.autoClear=!0,this.autoClearColor=!0,this.autoClearDepth=!0,this.autoClearStencil=!0,this.sortObjects=!0,this.clippingPlanes=[],this.localClippingEnabled=!1,this._outputColorSpace=Vn,this._useLegacyLights=!1,this.toneMapping=Vi,this.toneMappingExposure=1;const g=this;let E=!1,R=0,A=0,T=null,L=-1,j=null;const y=new Lt,C=new Lt;let J=null;const Q=new Ke(0);let b=0,X=n.width,W=n.height,$=1,P=null,I=null;const H=new Lt(0,0,X,W),q=new Lt(0,0,X,W);let ne=!1;const Ce=new n_;let O=!1,K=!1,le=null;const Te=new _t,ye=new Ye,ge=new z,$e={background:null,fog:null,environment:null,overrideMaterial:null,isScene:!0};function Ee(){return T===null?$:1}let U=i;function xt(M,N){for(let B=0;B<M.length;B++){const G=M[B],F=n.getContext(G,N);if(F!==null)return F}return null}try{const M={alpha:!0,depth:r,stencil:o,antialias:a,premultipliedAlpha:l,preserveDrawingBuffer:u,powerPreference:f,failIfMajorPerformanceCaveat:d};if("setAttribute"in n&&n.setAttribute("data-engine",`three.js r${rd}`),n.addEventListener("webglcontextlost",ot,!1),n.addEventListener("webglcontextrestored",D,!1),n.addEventListener("webglcontextcreationerror",ue,!1),U===null){const N=["webgl2","webgl","experimental-webgl"];if(g.isWebGL1Renderer===!0&&N.shift(),U=xt(N,M),U===null)throw xt(N)?new Error("Error creating WebGL context with your selected attributes."):new Error("Error creating WebGL context.")}typeof WebGLRenderingContext<"u"&&U instanceof WebGLRenderingContext&&console.warn("THREE.WebGLRenderer: WebGL 1 support was deprecated in r153 and will be removed in r163."),U.getShaderPrecisionFormat===void 0&&(U.getShaderPrecisionFormat=function(){return{rangeMin:1,rangeMax:1,precision:1}})}catch(M){throw console.error("THREE.WebGLRenderer: "+M.message),M}let Me,Ue,Ae,He,Se,he,qe,w,S,V,Y,ie,ee,Ie,Pe,ae,fe,Fe,re,mt,Ge,we,ve,_e;function Xe(){Me=new iT(U),Ue=new K1(U,Me,e),Me.init(Ue),we=new Gw(U,Me,Ue),Ae=new Bw(U,Me,Ue),He=new sT(U),Se=new Aw,he=new Hw(U,Me,Ae,Se,Ue,we,He),qe=new Q1(g),w=new nT(g),S=new fE(U,Ue),ve=new $1(U,Me,S,Ue),V=new rT(U,S,He,ve),Y=new cT(U,V,S,He),re=new uT(U,Ue,he),ae=new Z1(Se),ie=new ww(g,qe,w,Me,Ue,ve,ae),ee=new Kw(g,Se),Ie=new Rw,Pe=new Uw(Me,Ue),Fe=new Y1(g,qe,w,Ae,Y,h,l),fe=new zw(g,Y,Ue),_e=new Zw(U,He,Ue,Ae),mt=new q1(U,Me,He,Ue),Ge=new oT(U,Me,He,Ue),He.programs=ie.programs,g.capabilities=Ue,g.extensions=Me,g.properties=Se,g.renderLists=Ie,g.shadowMap=fe,g.state=Ae,g.info=He}Xe();const De=new $w(g,U);this.xr=De,this.getContext=function(){return U},this.getContextAttributes=function(){return U.getContextAttributes()},this.forceContextLoss=function(){const M=Me.get("WEBGL_lose_context");M&&M.loseContext()},this.forceContextRestore=function(){const M=Me.get("WEBGL_lose_context");M&&M.restoreContext()},this.getPixelRatio=function(){return $},this.setPixelRatio=function(M){M!==void 0&&($=M,this.setSize(X,W,!1))},this.getSize=function(M){return M.set(X,W)},this.setSize=function(M,N,B=!0){if(De.isPresenting){console.warn("THREE.WebGLRenderer: Can't change size while VR device is presenting.");return}X=M,W=N,n.width=Math.floor(M*$),n.height=Math.floor(N*$),B===!0&&(n.style.width=M+"px",n.style.height=N+"px"),this.setViewport(0,0,M,N)},this.getDrawingBufferSize=function(M){return M.set(X*$,W*$).floor()},this.setDrawingBufferSize=function(M,N,B){X=M,W=N,$=B,n.width=Math.floor(M*B),n.height=Math.floor(N*B),this.setViewport(0,0,M,N)},this.getCurrentViewport=function(M){return M.copy(y)},this.getViewport=function(M){return M.copy(H)},this.setViewport=function(M,N,B,G){M.isVector4?H.set(M.x,M.y,M.z,M.w):H.set(M,N,B,G),Ae.viewport(y.copy(H).multiplyScalar($).round())},this.getScissor=function(M){return M.copy(q)},this.setScissor=function(M,N,B,G){M.isVector4?q.set(M.x,M.y,M.z,M.w):q.set(M,N,B,G),Ae.scissor(C.copy(q).multiplyScalar($).round())},this.getScissorTest=function(){return ne},this.setScissorTest=function(M){Ae.setScissorTest(ne=M)},this.setOpaqueSort=function(M){P=M},this.setTransparentSort=function(M){I=M},this.getClearColor=function(M){return M.copy(Fe.getClearColor())},this.setClearColor=function(){Fe.setClearColor.apply(Fe,arguments)},this.getClearAlpha=function(){return Fe.getClearAlpha()},this.setClearAlpha=function(){Fe.setClearAlpha.apply(Fe,arguments)},this.clear=function(M=!0,N=!0,B=!0){let G=0;if(M){let F=!1;if(T!==null){const pe=T.texture.format;F=pe===Bv||pe===zv||pe===kv}if(F){const pe=T.texture.type,xe=pe===Wi||pe===Ni||pe===od||pe===yr||pe===Fv||pe===Ov,Re=Fe.getClearColor(),Le=Fe.getClearAlpha(),Be=Re.r,be=Re.g,Ne=Re.b;xe?(m[0]=Be,m[1]=be,m[2]=Ne,m[3]=Le,U.clearBufferuiv(U.COLOR,0,m)):(_[0]=Be,_[1]=be,_[2]=Ne,_[3]=Le,U.clearBufferiv(U.COLOR,0,_))}else G|=U.COLOR_BUFFER_BIT}N&&(G|=U.DEPTH_BUFFER_BIT),B&&(G|=U.STENCIL_BUFFER_BIT,this.state.buffers.stencil.setMask(4294967295)),U.clear(G)},this.clearColor=function(){this.clear(!0,!1,!1)},this.clearDepth=function(){this.clear(!1,!0,!1)},this.clearStencil=function(){this.clear(!1,!1,!0)},this.dispose=function(){n.removeEventListener("webglcontextlost",ot,!1),n.removeEventListener("webglcontextrestored",D,!1),n.removeEventListener("webglcontextcreationerror",ue,!1),Ie.dispose(),Pe.dispose(),Se.dispose(),qe.dispose(),w.dispose(),Y.dispose(),ve.dispose(),_e.dispose(),ie.dispose(),De.dispose(),De.removeEventListener("sessionstart",gn),De.removeEventListener("sessionend",et),le&&(le.dispose(),le=null),Ht.stop()};function ot(M){M.preventDefault(),console.log("THREE.WebGLRenderer: Context Lost."),E=!0}function D(){console.log("THREE.WebGLRenderer: Context Restored."),E=!1;const M=He.autoReset,N=fe.enabled,B=fe.autoUpdate,G=fe.needsUpdate,F=fe.type;Xe(),He.autoReset=M,fe.enabled=N,fe.autoUpdate=B,fe.needsUpdate=G,fe.type=F}function ue(M){console.error("THREE.WebGLRenderer: A WebGL context could not be created. Reason: ",M.statusMessage)}function k(M){const N=M.target;N.removeEventListener("dispose",k),oe(N)}function oe(M){de(M),Se.remove(M)}function de(M){const N=Se.get(M).programs;N!==void 0&&(N.forEach(function(B){ie.releaseProgram(B)}),M.isShaderMaterial&&ie.releaseShaderCache(M))}this.renderBufferDirect=function(M,N,B,G,F,pe){N===null&&(N=$e);const xe=F.isMesh&&F.matrixWorld.determinant()<0,Re=m_(M,N,B,G,F);Ae.setMaterial(G,xe);let Le=B.index,Be=1;if(G.wireframe===!0){if(Le=V.getWireframeAttribute(B),Le===void 0)return;Be=2}const be=B.drawRange,Ne=B.attributes.position;let ht=be.start*Be,an=(be.start+be.count)*Be;pe!==null&&(ht=Math.max(ht,pe.start*Be),an=Math.min(an,(pe.start+pe.count)*Be)),Le!==null?(ht=Math.max(ht,0),an=Math.min(an,Le.count)):Ne!=null&&(ht=Math.max(ht,0),an=Math.min(an,Ne.count));const Tt=an-ht;if(Tt<0||Tt===1/0)return;ve.setup(F,G,Re,B,Le);let qn,lt=mt;if(Le!==null&&(qn=S.get(Le),lt=Ge,lt.setIndex(qn)),F.isMesh)G.wireframe===!0?(Ae.setLineWidth(G.wireframeLinewidth*Ee()),lt.setMode(U.LINES)):lt.setMode(U.TRIANGLES);else if(F.isLine){let Oe=G.linewidth;Oe===void 0&&(Oe=1),Ae.setLineWidth(Oe*Ee()),F.isLineSegments?lt.setMode(U.LINES):F.isLineLoop?lt.setMode(U.LINE_LOOP):lt.setMode(U.LINE_STRIP)}else F.isPoints?lt.setMode(U.POINTS):F.isSprite&&lt.setMode(U.TRIANGLES);if(F.isBatchedMesh)lt.renderMultiDraw(F._multiDrawStarts,F._multiDrawCounts,F._multiDrawCount);else if(F.isInstancedMesh)lt.renderInstances(ht,Tt,F.count);else if(B.isInstancedBufferGeometry){const Oe=B._maxInstanceCount!==void 0?B._maxInstanceCount:1/0,jl=Math.min(B.instanceCount,Oe);lt.renderInstances(ht,Tt,jl)}else lt.render(ht,Tt)};function Ve(M,N,B){M.transparent===!0&&M.side===ri&&M.forceSinglePass===!1?(M.side=rn,M.needsUpdate=!0,Ws(M,N,B),M.side=Yi,M.needsUpdate=!0,Ws(M,N,B),M.side=ri):Ws(M,N,B)}this.compile=function(M,N,B=null){B===null&&(B=M),p=Pe.get(B),p.init(),v.push(p),B.traverseVisible(function(F){F.isLight&&F.layers.test(N.layers)&&(p.pushLight(F),F.castShadow&&p.pushShadow(F))}),M!==B&&M.traverseVisible(function(F){F.isLight&&F.layers.test(N.layers)&&(p.pushLight(F),F.castShadow&&p.pushShadow(F))}),p.setupLights(g._useLegacyLights);const G=new Set;return M.traverse(function(F){const pe=F.material;if(pe)if(Array.isArray(pe))for(let xe=0;xe<pe.length;xe++){const Re=pe[xe];Ve(Re,B,F),G.add(Re)}else Ve(pe,B,F),G.add(pe)}),v.pop(),p=null,G},this.compileAsync=function(M,N,B=null){const G=this.compile(M,N,B);return new Promise(F=>{function pe(){if(G.forEach(function(xe){Se.get(xe).currentProgram.isReady()&&G.delete(xe)}),G.size===0){F(M);return}setTimeout(pe,10)}Me.get("KHR_parallel_shader_compile")!==null?pe():setTimeout(pe,10)})};let Je=null;function Rt(M){Je&&Je(M)}function gn(){Ht.stop()}function et(){Ht.start()}const Ht=new i_;Ht.setAnimationLoop(Rt),typeof self<"u"&&Ht.setContext(self),this.setAnimationLoop=function(M){Je=M,De.setAnimationLoop(M),M===null?Ht.stop():Ht.start()},De.addEventListener("sessionstart",gn),De.addEventListener("sessionend",et),this.render=function(M,N){if(N!==void 0&&N.isCamera!==!0){console.error("THREE.WebGLRenderer.render: camera is not an instance of THREE.Camera.");return}if(E===!0)return;M.matrixWorldAutoUpdate===!0&&M.updateMatrixWorld(),N.parent===null&&N.matrixWorldAutoUpdate===!0&&N.updateMatrixWorld(),De.enabled===!0&&De.isPresenting===!0&&(De.cameraAutoUpdate===!0&&De.updateCamera(N),N=De.getCamera()),M.isScene===!0&&M.onBeforeRender(g,M,N,T),p=Pe.get(M,v.length),p.init(),v.push(p),Te.multiplyMatrices(N.projectionMatrix,N.matrixWorldInverse),Ce.setFromProjectionMatrix(Te),K=this.localClippingEnabled,O=ae.init(this.clippingPlanes,K),x=Ie.get(M,c.length),x.init(),c.push(x),Bn(M,N,0,g.sortObjects),x.finish(),g.sortObjects===!0&&x.sort(P,I),this.info.render.frame++,O===!0&&ae.beginShadows();const B=p.state.shadowsArray;if(fe.render(B,M,N),O===!0&&ae.endShadows(),this.info.autoReset===!0&&this.info.reset(),(De.enabled===!1||De.isPresenting===!1||De.hasDepthSensing()===!1)&&Fe.render(x,M),p.setupLights(g._useLegacyLights),N.isArrayCamera){const G=N.cameras;for(let F=0,pe=G.length;F<pe;F++){const xe=G[F];ld(x,M,xe,xe.viewport)}}else ld(x,M,N);T!==null&&(he.updateMultisampleRenderTarget(T),he.updateRenderTargetMipmap(T)),M.isScene===!0&&M.onAfterRender(g,M,N),ve.resetDefaultState(),L=-1,j=null,v.pop(),v.length>0?p=v[v.length-1]:p=null,c.pop(),c.length>0?x=c[c.length-1]:x=null};function Bn(M,N,B,G){if(M.visible===!1)return;if(M.layers.test(N.layers)){if(M.isGroup)B=M.renderOrder;else if(M.isLOD)M.autoUpdate===!0&&M.update(N);else if(M.isLight)p.pushLight(M),M.castShadow&&p.pushShadow(M);else if(M.isSprite){if(!M.frustumCulled||Ce.intersectsSprite(M)){G&&ge.setFromMatrixPosition(M.matrixWorld).applyMatrix4(Te);const xe=Y.update(M),Re=M.material;Re.visible&&x.push(M,xe,Re,B,ge.z,null)}}else if((M.isMesh||M.isLine||M.isPoints)&&(!M.frustumCulled||Ce.intersectsObject(M))){const xe=Y.update(M),Re=M.material;if(G&&(M.boundingSphere!==void 0?(M.boundingSphere===null&&M.computeBoundingSphere(),ge.copy(M.boundingSphere.center)):(xe.boundingSphere===null&&xe.computeBoundingSphere(),ge.copy(xe.boundingSphere.center)),ge.applyMatrix4(M.matrixWorld).applyMatrix4(Te)),Array.isArray(Re)){const Le=xe.groups;for(let Be=0,be=Le.length;Be<be;Be++){const Ne=Le[Be],ht=Re[Ne.materialIndex];ht&&ht.visible&&x.push(M,xe,ht,B,ge.z,Ne)}}else Re.visible&&x.push(M,xe,Re,B,ge.z,null)}}const pe=M.children;for(let xe=0,Re=pe.length;xe<Re;xe++)Bn(pe[xe],N,B,G)}function ld(M,N,B,G){const F=M.opaque,pe=M.transmissive,xe=M.transparent;p.setupLightsView(B),O===!0&&ae.setGlobalState(g.clippingPlanes,B),pe.length>0&&p_(F,pe,N,B),G&&Ae.viewport(y.copy(G)),F.length>0&&Vs(F,N,B),pe.length>0&&Vs(pe,N,B),xe.length>0&&Vs(xe,N,B),Ae.buffers.depth.setTest(!0),Ae.buffers.depth.setMask(!0),Ae.buffers.color.setMask(!0),Ae.setPolygonOffset(!1)}function p_(M,N,B,G){if((B.isScene===!0?B.overrideMaterial:null)!==null)return;const pe=Ue.isWebGL2;le===null&&(le=new Rr(1,1,{generateMipmaps:!0,type:Me.has("EXT_color_buffer_half_float")?Ls:Wi,minFilter:gr,samples:pe?4:0})),g.getDrawingBufferSize(ye),pe?le.setSize(ye.x,ye.y):le.setSize(of(ye.x),of(ye.y));const xe=g.getRenderTarget();g.setRenderTarget(le),g.getClearColor(Q),b=g.getClearAlpha(),b<1&&g.setClearColor(16777215,.5),g.clear();const Re=g.toneMapping;g.toneMapping=Vi,Vs(M,B,G),he.updateMultisampleRenderTarget(le),he.updateRenderTargetMipmap(le);let Le=!1;for(let Be=0,be=N.length;Be<be;Be++){const Ne=N[Be],ht=Ne.object,an=Ne.geometry,Tt=Ne.material,qn=Ne.group;if(Tt.side===ri&&ht.layers.test(G.layers)){const lt=Tt.side;Tt.side=rn,Tt.needsUpdate=!0,ud(ht,B,G,an,Tt,qn),Tt.side=lt,Tt.needsUpdate=!0,Le=!0}}Le===!0&&(he.updateMultisampleRenderTarget(le),he.updateRenderTargetMipmap(le)),g.setRenderTarget(xe),g.setClearColor(Q,b),g.toneMapping=Re}function Vs(M,N,B){const G=N.isScene===!0?N.overrideMaterial:null;for(let F=0,pe=M.length;F<pe;F++){const xe=M[F],Re=xe.object,Le=xe.geometry,Be=G===null?xe.material:G,be=xe.group;Re.layers.test(B.layers)&&ud(Re,N,B,Le,Be,be)}}function ud(M,N,B,G,F,pe){M.onBeforeRender(g,N,B,G,F,pe),M.modelViewMatrix.multiplyMatrices(B.matrixWorldInverse,M.matrixWorld),M.normalMatrix.getNormalMatrix(M.modelViewMatrix),F.onBeforeRender(g,N,B,G,M,pe),F.transparent===!0&&F.side===ri&&F.forceSinglePass===!1?(F.side=rn,F.needsUpdate=!0,g.renderBufferDirect(B,N,G,F,M,pe),F.side=Yi,F.needsUpdate=!0,g.renderBufferDirect(B,N,G,F,M,pe),F.side=ri):g.renderBufferDirect(B,N,G,F,M,pe),M.onAfterRender(g,N,B,G,F,pe)}function Ws(M,N,B){N.isScene!==!0&&(N=$e);const G=Se.get(M),F=p.state.lights,pe=p.state.shadowsArray,xe=F.state.version,Re=ie.getParameters(M,F.state,pe,N,B),Le=ie.getProgramCacheKey(Re);let Be=G.programs;G.environment=M.isMeshStandardMaterial?N.environment:null,G.fog=N.fog,G.envMap=(M.isMeshStandardMaterial?w:qe).get(M.envMap||G.environment),G.envMapRotation=G.environment!==null&&M.envMap===null?N.environmentRotation:M.envMapRotation,Be===void 0&&(M.addEventListener("dispose",k),Be=new Map,G.programs=Be);let be=Be.get(Le);if(be!==void 0){if(G.currentProgram===be&&G.lightsStateVersion===xe)return fd(M,Re),be}else Re.uniforms=ie.getUniforms(M),M.onBuild(B,Re,g),M.onBeforeCompile(Re,g),be=ie.acquireProgram(Re,Le),Be.set(Le,be),G.uniforms=Re.uniforms;const Ne=G.uniforms;return(!M.isShaderMaterial&&!M.isRawShaderMaterial||M.clipping===!0)&&(Ne.clippingPlanes=ae.uniform),fd(M,Re),G.needsLights=v_(M),G.lightsStateVersion=xe,G.needsLights&&(Ne.ambientLightColor.value=F.state.ambient,Ne.lightProbe.value=F.state.probe,Ne.directionalLights.value=F.state.directional,Ne.directionalLightShadows.value=F.state.directionalShadow,Ne.spotLights.value=F.state.spot,Ne.spotLightShadows.value=F.state.spotShadow,Ne.rectAreaLights.value=F.state.rectArea,Ne.ltc_1.value=F.state.rectAreaLTC1,Ne.ltc_2.value=F.state.rectAreaLTC2,Ne.pointLights.value=F.state.point,Ne.pointLightShadows.value=F.state.pointShadow,Ne.hemisphereLights.value=F.state.hemi,Ne.directionalShadowMap.value=F.state.directionalShadowMap,Ne.directionalShadowMatrix.value=F.state.directionalShadowMatrix,Ne.spotShadowMap.value=F.state.spotShadowMap,Ne.spotLightMatrix.value=F.state.spotLightMatrix,Ne.spotLightMap.value=F.state.spotLightMap,Ne.pointShadowMap.value=F.state.pointShadowMap,Ne.pointShadowMatrix.value=F.state.pointShadowMatrix),G.currentProgram=be,G.uniformsList=null,be}function cd(M){if(M.uniformsList===null){const N=M.currentProgram.getUniforms();M.uniformsList=Wa.seqWithValue(N.seq,M.uniforms)}return M.uniformsList}function fd(M,N){const B=Se.get(M);B.outputColorSpace=N.outputColorSpace,B.batching=N.batching,B.instancing=N.instancing,B.instancingColor=N.instancingColor,B.instancingMorph=N.instancingMorph,B.skinning=N.skinning,B.morphTargets=N.morphTargets,B.morphNormals=N.morphNormals,B.morphColors=N.morphColors,B.morphTargetsCount=N.morphTargetsCount,B.numClippingPlanes=N.numClippingPlanes,B.numIntersection=N.numClipIntersection,B.vertexAlphas=N.vertexAlphas,B.vertexTangents=N.vertexTangents,B.toneMapping=N.toneMapping}function m_(M,N,B,G,F){N.isScene!==!0&&(N=$e),he.resetTextureUnits();const pe=N.fog,xe=G.isMeshStandardMaterial?N.environment:null,Re=T===null?g.outputColorSpace:T.isXRRenderTarget===!0?T.texture.colorSpace:Qi,Le=(G.isMeshStandardMaterial?w:qe).get(G.envMap||xe),Be=G.vertexColors===!0&&!!B.attributes.color&&B.attributes.color.itemSize===4,be=!!B.attributes.tangent&&(!!G.normalMap||G.anisotropy>0),Ne=!!B.morphAttributes.position,ht=!!B.morphAttributes.normal,an=!!B.morphAttributes.color;let Tt=Vi;G.toneMapped&&(T===null||T.isXRRenderTarget===!0)&&(Tt=g.toneMapping);const qn=B.morphAttributes.position||B.morphAttributes.normal||B.morphAttributes.color,lt=qn!==void 0?qn.length:0,Oe=Se.get(G),jl=p.state.lights;if(O===!0&&(K===!0||M!==j)){const vn=M===j&&G.id===L;ae.setState(G,M,vn)}let st=!1;G.version===Oe.__version?(Oe.needsLights&&Oe.lightsStateVersion!==jl.state.version||Oe.outputColorSpace!==Re||F.isBatchedMesh&&Oe.batching===!1||!F.isBatchedMesh&&Oe.batching===!0||F.isInstancedMesh&&Oe.instancing===!1||!F.isInstancedMesh&&Oe.instancing===!0||F.isSkinnedMesh&&Oe.skinning===!1||!F.isSkinnedMesh&&Oe.skinning===!0||F.isInstancedMesh&&Oe.instancingColor===!0&&F.instanceColor===null||F.isInstancedMesh&&Oe.instancingColor===!1&&F.instanceColor!==null||F.isInstancedMesh&&Oe.instancingMorph===!0&&F.morphTexture===null||F.isInstancedMesh&&Oe.instancingMorph===!1&&F.morphTexture!==null||Oe.envMap!==Le||G.fog===!0&&Oe.fog!==pe||Oe.numClippingPlanes!==void 0&&(Oe.numClippingPlanes!==ae.numPlanes||Oe.numIntersection!==ae.numIntersection)||Oe.vertexAlphas!==Be||Oe.vertexTangents!==be||Oe.morphTargets!==Ne||Oe.morphNormals!==ht||Oe.morphColors!==an||Oe.toneMapping!==Tt||Ue.isWebGL2===!0&&Oe.morphTargetsCount!==lt)&&(st=!0):(st=!0,Oe.__version=G.version);let Ji=Oe.currentProgram;st===!0&&(Ji=Ws(G,N,F));let dd=!1,Fo=!1,Yl=!1;const Ut=Ji.getUniforms(),er=Oe.uniforms;if(Ae.useProgram(Ji.program)&&(dd=!0,Fo=!0,Yl=!0),G.id!==L&&(L=G.id,Fo=!0),dd||j!==M){Ut.setValue(U,"projectionMatrix",M.projectionMatrix),Ut.setValue(U,"viewMatrix",M.matrixWorldInverse);const vn=Ut.map.cameraPosition;vn!==void 0&&vn.setValue(U,ge.setFromMatrixPosition(M.matrixWorld)),Ue.logarithmicDepthBuffer&&Ut.setValue(U,"logDepthBufFC",2/(Math.log(M.far+1)/Math.LN2)),(G.isMeshPhongMaterial||G.isMeshToonMaterial||G.isMeshLambertMaterial||G.isMeshBasicMaterial||G.isMeshStandardMaterial||G.isShaderMaterial)&&Ut.setValue(U,"isOrthographic",M.isOrthographicCamera===!0),j!==M&&(j=M,Fo=!0,Yl=!0)}if(F.isSkinnedMesh){Ut.setOptional(U,F,"bindMatrix"),Ut.setOptional(U,F,"bindMatrixInverse");const vn=F.skeleton;vn&&(Ue.floatVertexTextures?(vn.boneTexture===null&&vn.computeBoneTexture(),Ut.setValue(U,"boneTexture",vn.boneTexture,he)):console.warn("THREE.WebGLRenderer: SkinnedMesh can only be used with WebGL 2. With WebGL 1 OES_texture_float and vertex textures support is required."))}F.isBatchedMesh&&(Ut.setOptional(U,F,"batchingTexture"),Ut.setValue(U,"batchingTexture",F._matricesTexture,he));const $l=B.morphAttributes;if(($l.position!==void 0||$l.normal!==void 0||$l.color!==void 0&&Ue.isWebGL2===!0)&&re.update(F,B,Ji),(Fo||Oe.receiveShadow!==F.receiveShadow)&&(Oe.receiveShadow=F.receiveShadow,Ut.setValue(U,"receiveShadow",F.receiveShadow)),G.isMeshGouraudMaterial&&G.envMap!==null&&(er.envMap.value=Le,er.flipEnvMap.value=Le.isCubeTexture&&Le.isRenderTargetTexture===!1?-1:1),Fo&&(Ut.setValue(U,"toneMappingExposure",g.toneMappingExposure),Oe.needsLights&&g_(er,Yl),pe&&G.fog===!0&&ee.refreshFogUniforms(er,pe),ee.refreshMaterialUniforms(er,G,$,W,le),Wa.upload(U,cd(Oe),er,he)),G.isShaderMaterial&&G.uniformsNeedUpdate===!0&&(Wa.upload(U,cd(Oe),er,he),G.uniformsNeedUpdate=!1),G.isSpriteMaterial&&Ut.setValue(U,"center",F.center),Ut.setValue(U,"modelViewMatrix",F.modelViewMatrix),Ut.setValue(U,"normalMatrix",F.normalMatrix),Ut.setValue(U,"modelMatrix",F.matrixWorld),G.isShaderMaterial||G.isRawShaderMaterial){const vn=G.uniformsGroups;for(let ql=0,__=vn.length;ql<__;ql++)if(Ue.isWebGL2){const hd=vn[ql];_e.update(hd,Ji),_e.bind(hd,Ji)}else console.warn("THREE.WebGLRenderer: Uniform Buffer Objects can only be used with WebGL 2.")}return Ji}function g_(M,N){M.ambientLightColor.needsUpdate=N,M.lightProbe.needsUpdate=N,M.directionalLights.needsUpdate=N,M.directionalLightShadows.needsUpdate=N,M.pointLights.needsUpdate=N,M.pointLightShadows.needsUpdate=N,M.spotLights.needsUpdate=N,M.spotLightShadows.needsUpdate=N,M.rectAreaLights.needsUpdate=N,M.hemisphereLights.needsUpdate=N}function v_(M){return M.isMeshLambertMaterial||M.isMeshToonMaterial||M.isMeshPhongMaterial||M.isMeshStandardMaterial||M.isShadowMaterial||M.isShaderMaterial&&M.lights===!0}this.getActiveCubeFace=function(){return R},this.getActiveMipmapLevel=function(){return A},this.getRenderTarget=function(){return T},this.setRenderTargetTextures=function(M,N,B){Se.get(M.texture).__webglTexture=N,Se.get(M.depthTexture).__webglTexture=B;const G=Se.get(M);G.__hasExternalTextures=!0,G.__autoAllocateDepthBuffer=B===void 0,G.__autoAllocateDepthBuffer||Me.has("WEBGL_multisampled_render_to_texture")===!0&&(console.warn("THREE.WebGLRenderer: Render-to-texture extension was disabled because an external texture was provided"),G.__useRenderToTexture=!1)},this.setRenderTargetFramebuffer=function(M,N){const B=Se.get(M);B.__webglFramebuffer=N,B.__useDefaultFramebuffer=N===void 0},this.setRenderTarget=function(M,N=0,B=0){T=M,R=N,A=B;let G=!0,F=null,pe=!1,xe=!1;if(M){const Le=Se.get(M);Le.__useDefaultFramebuffer!==void 0?(Ae.bindFramebuffer(U.FRAMEBUFFER,null),G=!1):Le.__webglFramebuffer===void 0?he.setupRenderTarget(M):Le.__hasExternalTextures&&he.rebindTextures(M,Se.get(M.texture).__webglTexture,Se.get(M.depthTexture).__webglTexture);const Be=M.texture;(Be.isData3DTexture||Be.isDataArrayTexture||Be.isCompressedArrayTexture)&&(xe=!0);const be=Se.get(M).__webglFramebuffer;M.isWebGLCubeRenderTarget?(Array.isArray(be[N])?F=be[N][B]:F=be[N],pe=!0):Ue.isWebGL2&&M.samples>0&&he.useMultisampledRTT(M)===!1?F=Se.get(M).__webglMultisampledFramebuffer:Array.isArray(be)?F=be[B]:F=be,y.copy(M.viewport),C.copy(M.scissor),J=M.scissorTest}else y.copy(H).multiplyScalar($).floor(),C.copy(q).multiplyScalar($).floor(),J=ne;if(Ae.bindFramebuffer(U.FRAMEBUFFER,F)&&Ue.drawBuffers&&G&&Ae.drawBuffers(M,F),Ae.viewport(y),Ae.scissor(C),Ae.setScissorTest(J),pe){const Le=Se.get(M.texture);U.framebufferTexture2D(U.FRAMEBUFFER,U.COLOR_ATTACHMENT0,U.TEXTURE_CUBE_MAP_POSITIVE_X+N,Le.__webglTexture,B)}else if(xe){const Le=Se.get(M.texture),Be=N||0;U.framebufferTextureLayer(U.FRAMEBUFFER,U.COLOR_ATTACHMENT0,Le.__webglTexture,B||0,Be)}L=-1},this.readRenderTargetPixels=function(M,N,B,G,F,pe,xe){if(!(M&&M.isWebGLRenderTarget)){console.error("THREE.WebGLRenderer.readRenderTargetPixels: renderTarget is not THREE.WebGLRenderTarget.");return}let Re=Se.get(M).__webglFramebuffer;if(M.isWebGLCubeRenderTarget&&xe!==void 0&&(Re=Re[xe]),Re){Ae.bindFramebuffer(U.FRAMEBUFFER,Re);try{const Le=M.texture,Be=Le.format,be=Le.type;if(Be!==In&&we.convert(Be)!==U.getParameter(U.IMPLEMENTATION_COLOR_READ_FORMAT)){console.error("THREE.WebGLRenderer.readRenderTargetPixels: renderTarget is not in RGBA or implementation defined format.");return}const Ne=be===Ls&&(Me.has("EXT_color_buffer_half_float")||Ue.isWebGL2&&Me.has("EXT_color_buffer_float"));if(be!==Wi&&we.convert(be)!==U.getParameter(U.IMPLEMENTATION_COLOR_READ_TYPE)&&!(be===oi&&(Ue.isWebGL2||Me.has("OES_texture_float")||Me.has("WEBGL_color_buffer_float")))&&!Ne){console.error("THREE.WebGLRenderer.readRenderTargetPixels: renderTarget is not in UnsignedByteType or implementation defined type.");return}N>=0&&N<=M.width-G&&B>=0&&B<=M.height-F&&U.readPixels(N,B,G,F,we.convert(Be),we.convert(be),pe)}finally{const Le=T!==null?Se.get(T).__webglFramebuffer:null;Ae.bindFramebuffer(U.FRAMEBUFFER,Le)}}},this.copyFramebufferToTexture=function(M,N,B=0){const G=Math.pow(2,-B),F=Math.floor(N.image.width*G),pe=Math.floor(N.image.height*G);he.setTexture2D(N,0),U.copyTexSubImage2D(U.TEXTURE_2D,B,0,0,M.x,M.y,F,pe),Ae.unbindTexture()},this.copyTextureToTexture=function(M,N,B,G=0){const F=N.image.width,pe=N.image.height,xe=we.convert(B.format),Re=we.convert(B.type);he.setTexture2D(B,0),U.pixelStorei(U.UNPACK_FLIP_Y_WEBGL,B.flipY),U.pixelStorei(U.UNPACK_PREMULTIPLY_ALPHA_WEBGL,B.premultiplyAlpha),U.pixelStorei(U.UNPACK_ALIGNMENT,B.unpackAlignment),N.isDataTexture?U.texSubImage2D(U.TEXTURE_2D,G,M.x,M.y,F,pe,xe,Re,N.image.data):N.isCompressedTexture?U.compressedTexSubImage2D(U.TEXTURE_2D,G,M.x,M.y,N.mipmaps[0].width,N.mipmaps[0].height,xe,N.mipmaps[0].data):U.texSubImage2D(U.TEXTURE_2D,G,M.x,M.y,xe,Re,N.image),G===0&&B.generateMipmaps&&U.generateMipmap(U.TEXTURE_2D),Ae.unbindTexture()},this.copyTextureToTexture3D=function(M,N,B,G,F=0){if(g.isWebGL1Renderer){console.warn("THREE.WebGLRenderer.copyTextureToTexture3D: can only be used with WebGL2.");return}const pe=Math.round(M.max.x-M.min.x),xe=Math.round(M.max.y-M.min.y),Re=M.max.z-M.min.z+1,Le=we.convert(G.format),Be=we.convert(G.type);let be;if(G.isData3DTexture)he.setTexture3D(G,0),be=U.TEXTURE_3D;else if(G.isDataArrayTexture||G.isCompressedArrayTexture)he.setTexture2DArray(G,0),be=U.TEXTURE_2D_ARRAY;else{console.warn("THREE.WebGLRenderer.copyTextureToTexture3D: only supports THREE.DataTexture3D and THREE.DataTexture2DArray.");return}U.pixelStorei(U.UNPACK_FLIP_Y_WEBGL,G.flipY),U.pixelStorei(U.UNPACK_PREMULTIPLY_ALPHA_WEBGL,G.premultiplyAlpha),U.pixelStorei(U.UNPACK_ALIGNMENT,G.unpackAlignment);const Ne=U.getParameter(U.UNPACK_ROW_LENGTH),ht=U.getParameter(U.UNPACK_IMAGE_HEIGHT),an=U.getParameter(U.UNPACK_SKIP_PIXELS),Tt=U.getParameter(U.UNPACK_SKIP_ROWS),qn=U.getParameter(U.UNPACK_SKIP_IMAGES),lt=B.isCompressedTexture?B.mipmaps[F]:B.image;U.pixelStorei(U.UNPACK_ROW_LENGTH,lt.width),U.pixelStorei(U.UNPACK_IMAGE_HEIGHT,lt.height),U.pixelStorei(U.UNPACK_SKIP_PIXELS,M.min.x),U.pixelStorei(U.UNPACK_SKIP_ROWS,M.min.y),U.pixelStorei(U.UNPACK_SKIP_IMAGES,M.min.z),B.isDataTexture||B.isData3DTexture?U.texSubImage3D(be,F,N.x,N.y,N.z,pe,xe,Re,Le,Be,lt.data):G.isCompressedArrayTexture?U.compressedTexSubImage3D(be,F,N.x,N.y,N.z,pe,xe,Re,Le,lt.data):U.texSubImage3D(be,F,N.x,N.y,N.z,pe,xe,Re,Le,Be,lt),U.pixelStorei(U.UNPACK_ROW_LENGTH,Ne),U.pixelStorei(U.UNPACK_IMAGE_HEIGHT,ht),U.pixelStorei(U.UNPACK_SKIP_PIXELS,an),U.pixelStorei(U.UNPACK_SKIP_ROWS,Tt),U.pixelStorei(U.UNPACK_SKIP_IMAGES,qn),F===0&&G.generateMipmaps&&U.generateMipmap(be),Ae.unbindTexture()},this.initTexture=function(M){M.isCubeTexture?he.setTextureCube(M,0):M.isData3DTexture?he.setTexture3D(M,0):M.isDataArrayTexture||M.isCompressedArrayTexture?he.setTexture2DArray(M,0):he.setTexture2D(M,0),Ae.unbindTexture()},this.resetState=function(){R=0,A=0,T=null,Ae.reset(),ve.reset()},typeof __THREE_DEVTOOLS__<"u"&&__THREE_DEVTOOLS__.dispatchEvent(new CustomEvent("observe",{detail:this}))}get coordinateSystem(){return li}get outputColorSpace(){return this._outputColorSpace}set outputColorSpace(e){this._outputColorSpace=e;const n=this.getContext();n.drawingBufferColorSpace=e===sd?"display-p3":"srgb",n.unpackColorSpace=Qe.workingColorSpace===Gl?"display-p3":"srgb"}get useLegacyLights(){return console.warn("THREE.WebGLRenderer: The property .useLegacyLights has been deprecated. Migrate your lighting according to the following guide: https://discourse.threejs.org/t/updates-to-lighting-in-three-js-r155/53733."),this._useLegacyLights}set useLegacyLights(e){console.warn("THREE.WebGLRenderer: The property .useLegacyLights has been deprecated. Migrate your lighting according to the following guide: https://discourse.threejs.org/t/updates-to-lighting-in-three-js-r155/53733."),this._useLegacyLights=e}}class Qw extends c_{}Qw.prototype.isWebGL1Renderer=!0;class Jw extends sn{constructor(){super(),this.isScene=!0,this.type="Scene",this.background=null,this.environment=null,this.fog=null,this.backgroundBlurriness=0,this.backgroundIntensity=1,this.backgroundRotation=new mi,this.environmentRotation=new mi,this.overrideMaterial=null,typeof __THREE_DEVTOOLS__<"u"&&__THREE_DEVTOOLS__.dispatchEvent(new CustomEvent("observe",{detail:this}))}copy(e,n){return super.copy(e,n),e.background!==null&&(this.background=e.background.clone()),e.environment!==null&&(this.environment=e.environment.clone()),e.fog!==null&&(this.fog=e.fog.clone()),this.backgroundBlurriness=e.backgroundBlurriness,this.backgroundIntensity=e.backgroundIntensity,this.backgroundRotation.copy(e.backgroundRotation),this.environmentRotation.copy(e.environmentRotation),e.overrideMaterial!==null&&(this.overrideMaterial=e.overrideMaterial.clone()),this.matrixAutoUpdate=e.matrixAutoUpdate,this}toJSON(e){const n=super.toJSON(e);return this.fog!==null&&(n.object.fog=this.fog.toJSON()),this.backgroundBlurriness>0&&(n.object.backgroundBlurriness=this.backgroundBlurriness),this.backgroundIntensity!==1&&(n.object.backgroundIntensity=this.backgroundIntensity),n.object.backgroundRotation=this.backgroundRotation.toArray(),n.object.environmentRotation=this.environmentRotation.toArray(),n}}class f_ extends Hs{constructor(e){super(),this.isPointsMaterial=!0,this.type="PointsMaterial",this.color=new Ke(16777215),this.map=null,this.alphaMap=null,this.size=1,this.sizeAttenuation=!0,this.fog=!0,this.setValues(e)}copy(e){return super.copy(e),this.color.copy(e.color),this.map=e.map,this.alphaMap=e.alphaMap,this.size=e.size,this.sizeAttenuation=e.sizeAttenuation,this.fog=e.fog,this}}const Jp=new _t,af=new Yv,La=new Vl,ba=new z;class eA extends sn{constructor(e=new vi,n=new f_){super(),this.isPoints=!0,this.type="Points",this.geometry=e,this.material=n,this.updateMorphTargets()}copy(e,n){return super.copy(e,n),this.material=Array.isArray(e.material)?e.material.slice():e.material,this.geometry=e.geometry,this}raycast(e,n){const i=this.geometry,r=this.matrixWorld,o=e.params.Points.threshold,s=i.drawRange;if(i.boundingSphere===null&&i.computeBoundingSphere(),La.copy(i.boundingSphere),La.applyMatrix4(r),La.radius+=o,e.ray.intersectsSphere(La)===!1)return;Jp.copy(r).invert(),af.copy(e.ray).applyMatrix4(Jp);const a=o/((this.scale.x+this.scale.y+this.scale.z)/3),l=a*a,u=i.index,d=i.attributes.position;if(u!==null){const h=Math.max(0,s.start),m=Math.min(u.count,s.start+s.count);for(let _=h,x=m;_<x;_++){const p=u.getX(_);ba.fromBufferAttribute(d,p),em(ba,p,l,r,e,n,this)}}else{const h=Math.max(0,s.start),m=Math.min(d.count,s.start+s.count);for(let _=h,x=m;_<x;_++)ba.fromBufferAttribute(d,_),em(ba,_,l,r,e,n,this)}}updateMorphTargets(){const n=this.geometry.morphAttributes,i=Object.keys(n);if(i.length>0){const r=n[i[0]];if(r!==void 0){this.morphTargetInfluences=[],this.morphTargetDictionary={};for(let o=0,s=r.length;o<s;o++){const a=r[o].name||String(o);this.morphTargetInfluences.push(0),this.morphTargetDictionary[a]=o}}}}}function em(t,e,n,i,r,o,s){const a=af.distanceSqToPoint(t);if(a<n){const l=new z;af.closestPointToPoint(t,l),l.applyMatrix4(i);const u=r.ray.origin.distanceTo(l);if(u<r.near||u>r.far)return;o.push({distance:u,distanceToRay:Math.sqrt(a),point:l,index:e,face:null,object:s})}}typeof __THREE_DEVTOOLS__<"u"&&__THREE_DEVTOOLS__.dispatchEvent(new CustomEvent("register",{detail:{revision:rd}}));typeof window<"u"&&(window.__THREE__?console.warn("WARNING: Multiple instances of Three.js being imported."):window.__THREE__=rd);function tA(){const t=Z.useRef();return Z.useEffect(()=>{const i=t.current,r=new Jw,o=new Sn(75,window.innerWidth/window.innerHeight,.1,1e3),s=new c_({alpha:!0}),a=new vi,l=new f_({color:16777215}),u=new Ye,f=new Ye;let d=500,h=window.innerWidth<640;o.position.z=500,s.setSize(window.innerWidth,window.innerHeight),t.current.appendChild(s.domElement);const m=new Float32Array(1e3*3);for(let g=0;g<1e3;g++)m[g*3]=v(),m[g*3+1]=v(),m[g*3+2]=v();a.setAttribute("position",new kn(m,3));const _=new eA(a,l);r.add(_);function x(g){u.x=g.clientX/window.innerWidth*2-1,u.y=-(g.clientY/window.innerHeight)*2+1}window.addEventListener("mousemove",x,!1);function p(g){const E=Math.sign(g.deltaY),R=window.scrollY,A=document.body.scrollHeight-window.innerHeight;if(R===0&&E<0||R===A&&E>0)return;const T=E*8;d-=Math.max(-10,Math.min(10,T))}window.addEventListener("wheel",p,!1);function c(){requestAnimationFrame(c),h?(f.x+=.001,f.y+=.001):(f.x=u.y*.2,f.y=u.x*.2),_.rotation.x+=(f.x-_.rotation.x)*.05,_.rotation.y+=(f.y-_.rotation.y)*.05,o.position.z+=(d-o.position.z)*.05,s.render(r,o)}c();function v(){return Math.random()*800-400}return()=>{window.removeEventListener("mousemove",x),window.removeEventListener("wheel",p),i&&i.removeChild(s.domElement)}},[]),Mn.createElement("div",{ref:t,id:"galaxy"})}var d_={color:void 0,size:void 0,className:void 0,style:void 0,attr:void 0},tm=Mn.createContext&&Mn.createContext(d_),nA=["attr","size","title"];function iA(t,e){if(t==null)return{};var n=rA(t,e),i,r;if(Object.getOwnPropertySymbols){var o=Object.getOwnPropertySymbols(t);for(r=0;r<o.length;r++)i=o[r],!(e.indexOf(i)>=0)&&Object.prototype.propertyIsEnumerable.call(t,i)&&(n[i]=t[i])}return n}function rA(t,e){if(t==null)return{};var n={},i=Object.keys(t),r,o;for(o=0;o<i.length;o++)r=i[o],!(e.indexOf(r)>=0)&&(n[r]=t[r]);return n}function El(){return El=Object.assign?Object.assign.bind():function(t){for(var e=1;e<arguments.length;e++){var n=arguments[e];for(var i in n)Object.prototype.hasOwnProperty.call(n,i)&&(t[i]=n[i])}return t},El.apply(this,arguments)}function nm(t,e){var n=Object.keys(t);if(Object.getOwnPropertySymbols){var i=Object.getOwnPropertySymbols(t);e&&(i=i.filter(function(r){return Object.getOwnPropertyDescriptor(t,r).enumerable})),n.push.apply(n,i)}return n}function Ml(t){for(var e=1;e<arguments.length;e++){var n=arguments[e]!=null?arguments[e]:{};e%2?nm(Object(n),!0).forEach(function(i){oA(t,i,n[i])}):Object.getOwnPropertyDescriptors?Object.defineProperties(t,Object.getOwnPropertyDescriptors(n)):nm(Object(n)).forEach(function(i){Object.defineProperty(t,i,Object.getOwnPropertyDescriptor(n,i))})}return t}function oA(t,e,n){return e=sA(e),e in t?Object.defineProperty(t,e,{value:n,enumerable:!0,configurable:!0,writable:!0}):t[e]=n,t}function sA(t){var e=aA(t,"string");return typeof e=="symbol"?e:String(e)}function aA(t,e){if(typeof t!="object"||t===null)return t;var n=t[Symbol.toPrimitive];if(n!==void 0){var i=n.call(t,e||"default");if(typeof i!="object")return i;throw new TypeError("@@toPrimitive must return a primitive value.")}return(e==="string"?String:Number)(t)}function h_(t){return t&&t.map((e,n)=>Mn.createElement(e.tag,Ml({key:n},e.attr),h_(e.child)))}function Io(t){return e=>Mn.createElement(lA,El({attr:Ml({},t.attr)},e),h_(t.child))}function lA(t){var e=n=>{var{attr:i,size:r,title:o}=t,s=iA(t,nA),a=r||n.size||"1em",l;return n.className&&(l=n.className),t.className&&(l=(l?l+" ":"")+t.className),Mn.createElement("svg",El({stroke:"currentColor",fill:"currentColor",strokeWidth:"0"},n.attr,i,s,{className:l,style:Ml(Ml({color:t.color||n.color},n.style),t.style),height:a,width:a,xmlns:"http://www.w3.org/2000/svg"}),o&&Mn.createElement("title",null,o),t.children)};return tm!==void 0?Mn.createElement(tm.Consumer,null,n=>e(n)):e(d_)}function uA(t){return Io({tag:"svg",attr:{viewBox:"0 0 496 512"},child:[{tag:"path",attr:{d:"M165.9 397.4c0 2-2.3 3.6-5.2 3.6-3.3.3-5.6-1.3-5.6-3.6 0-2 2.3-3.6 5.2-3.6 3-.3 5.6 1.3 5.6 3.6zm-31.1-4.5c-.7 2 1.3 4.3 4.3 4.9 2.6 1 5.6 0 6.2-2s-1.3-4.3-4.3-5.2c-2.6-.7-5.5.3-6.2 2.3zm44.2-1.7c-2.9.7-4.9 2.6-4.6 4.9.3 2 2.9 3.3 5.9 2.6 2.9-.7 4.9-2.6 4.6-4.6-.3-1.9-3-3.2-5.9-2.9zM244.8 8C106.1 8 0 113.3 0 252c0 110.9 69.8 205.8 169.5 239.2 12.8 2.3 17.3-5.6 17.3-12.1 0-6.2-.3-40.4-.3-61.4 0 0-70 15-84.7-29.8 0 0-11.4-29.1-27.8-36.6 0 0-22.9-15.7 1.6-15.4 0 0 24.9 2 38.6 25.8 21.9 38.6 58.6 27.5 72.9 20.9 2.3-16 8.8-27.1 16-33.7-55.9-6.2-112.3-14.3-112.3-110.5 0-27.5 7.6-41.3 23.6-58.9-2.6-6.5-11.1-33.3 2.6-67.9 20.9-6.5 69 27 69 27 20-5.6 41.5-8.5 62.8-8.5s42.8 2.9 62.8 8.5c0 0 48.1-33.6 69-27 13.7 34.7 5.2 61.4 2.6 67.9 16 17.7 25.8 31.5 25.8 58.9 0 96.5-58.9 104.2-114.8 110.5 9.2 7.9 17 22.9 17 46.4 0 33.7-.3 75.4-.3 83.6 0 6.5 4.6 14.4 17.3 12.1C428.2 457.8 496 362.9 496 252 496 113.3 383.5 8 244.8 8zM97.2 352.9c-1.3 1-1 3.3.7 5.2 1.6 1.6 3.9 2.3 5.2 1 1.3-1 1-3.3-.7-5.2-1.6-1.6-3.9-2.3-5.2-1zm-10.8-8.1c-.7 1.3.3 2.9 2.3 3.9 1.6 1 3.6.7 4.3-.7.7-1.3-.3-2.9-2.3-3.9-2-.6-3.6-.3-4.3.7zm32.4 35.6c-1.6 1.3-1 4.3 1.3 6.2 2.3 2.3 5.2 2.6 6.5 1 1.3-1.3.7-4.3-1.3-6.2-2.2-2.3-5.2-2.6-6.5-1zm-11.4-14.7c-1.6 1-1.6 3.6 0 5.9 1.6 2.3 4.3 3.3 5.6 2.3 1.6-1.3 1.6-3.9 0-6.2-1.4-2.3-4-3.3-5.6-2z"},child:[]}]})(t)}function im(t){return Io({tag:"svg",attr:{viewBox:"0 0 448 512"},child:[{tag:"path",attr:{d:"M448 360V24c0-13.3-10.7-24-24-24H96C43 0 0 43 0 96v320c0 53 43 96 96 96h328c13.3 0 24-10.7 24-24v-16c0-7.5-3.5-14.3-8.9-18.7-4.2-15.4-4.2-59.3 0-74.7 5.4-4.3 8.9-11.1 8.9-18.6zM128 134c0-3.3 2.7-6 6-6h212c3.3 0 6 2.7 6 6v20c0 3.3-2.7 6-6 6H134c-3.3 0-6-2.7-6-6v-20zm0 64c0-3.3 2.7-6 6-6h212c3.3 0 6 2.7 6 6v20c0 3.3-2.7 6-6 6H134c-3.3 0-6-2.7-6-6v-20zm253.4 250H96c-17.7 0-32-14.3-32-32 0-17.6 14.4-32 32-32h285.4c-1.9 17.1-1.9 46.9 0 64z"},child:[]}]})(t)}function cA(t){return Io({tag:"svg",attr:{viewBox:"0 0 512 512"},child:[{tag:"path",attr:{d:"M502.3 190.8c3.9-3.1 9.7-.2 9.7 4.7V400c0 26.5-21.5 48-48 48H48c-26.5 0-48-21.5-48-48V195.6c0-5 5.7-7.8 9.7-4.7 22.4 17.4 52.1 39.5 154.1 113.6 21.1 15.4 56.7 47.8 92.2 47.6 35.7.3 72-32.8 92.3-47.6 102-74.1 131.6-96.3 154-113.7zM256 320c23.2.4 56.6-29.2 73.4-41.4 132.7-96.3 142.8-104.7 173.4-128.7 5.8-4.5 9.2-11.5 9.2-18.9v-19c0-26.5-21.5-48-48-48H48C21.5 64 0 85.5 0 112v19c0 7.4 3.4 14.3 9.2 18.9 30.6 23.9 40.7 32.4 173.4 128.7 16.8 12.2 50.2 41.8 73.4 41.4z"},child:[]}]})(t)}function fA(t){return Io({tag:"svg",attr:{viewBox:"0 0 512 512"},child:[{tag:"path",attr:{d:"M432,320H400a16,16,0,0,0-16,16V448H64V128H208a16,16,0,0,0,16-16V80a16,16,0,0,0-16-16H48A48,48,0,0,0,0,112V464a48,48,0,0,0,48,48H400a48,48,0,0,0,48-48V336A16,16,0,0,0,432,320ZM488,0h-128c-21.37,0-32.05,25.91-17,41l35.73,35.73L135,320.37a24,24,0,0,0,0,34L157.67,377a24,24,0,0,0,34,0L435.28,133.32,471,169c15,15,41,4.5,41-17V24A24,24,0,0,0,488,0Z"},child:[]}]})(t)}const dA=()=>{const[t,e]=Z.useState([]),[n,i]=Z.useState(!1),[r,o]=Z.useState(null),[s,a]=Z.useState(window.innerWidth>640),l=Z.useMemo(()=>["FRC2706/MergeData","read-me-35/read-me-35.github.io"],[]),u=[{name:"Food Classification 86M",repo:"jwt2706/google-vit-base-patch16-224-in21k-finetuned-food-classification-86M-v0.1"}];return Z.useEffect(()=>{const f=async m=>{try{const _=await fetch(`https://api.github.com/repos/${m}`);if(!_.ok)throw new Error(`HTTP error! status: ${_.status}`);return await _.json()}catch(_){o(_)}},d=async()=>{try{const m=await fetch("https://api.github.com/users/jwt2706/repos");if(!m.ok)throw new Error(`HTTP error! status: ${m.status}`);return(await m.json()).filter(x=>x.description&&x.description.includes("[s!]"))}catch(m){o(m)}};(async()=>{i(!0);try{const m=await d();let _=[];return Array.isArray(l)&&(_=await Promise.all(l.map(f))),[...m,..._]}catch(m){o(m)}finally{i(!1)}})().then(m=>{if(m){const _=m.filter(x=>!!x);_.sort((x,p)=>new Date(p.created_at).getTime()-new Date(x.created_at).getTime()),e(_)}})},[l]),ce.jsxs("div",{children:[ce.jsx("button",{onClick:()=>a(!s),className:"fixed top-0 left-0 m-4 z-20 text-white border border-white hover:bg-white hover:text-black font-bold px-2 py-1 rounded-md",children:s?"Hide":"Show"}),ce.jsxs("aside",{className:`fixed left-0 top-0 z-10 h-screen w-64 bg-gray-800 bg-opacity-90 sm:bg-opacity-50 text-white p-6 transition-all duration-500 shadow-lg overflow-y-auto ${s?"translate-x-0":"-translate-x-full"}`,children:[ce.jsx("br",{}),ce.jsx("h2",{className:"text-2xl my-4 text-center",children:"Featured Projects"}),n?ce.jsx("p",{children:"Fetching repos..."}):r?ce.jsx("p",{children:"There was a problem fetching the repos... D:"}):ce.jsxs(ce.Fragment,{children:[ce.jsx("ul",{className:"list-none list-inside",children:t.map(f=>ce.jsxs("li",{className:"mb-2 px-4 py-3 hover:bg-gray-700 rounded border border-gray-500 border-opacity-50",title:f.description.replace("[s!]",""),children:[ce.jsx("span",{className:"block text-left mb-2",children:f.name}),ce.jsxs("div",{className:"flex space-x-2",children:[f.has_pages&&ce.jsx("a",{href:`https://${f.owner.login}.github.io/${f.name}`,className:"text-blue-400 transition-transform duration-200 transform hover:scale-150",target:"_blank",rel:"noopener noreferrer","aria-label":"External link to project",children:ce.jsx(fA,{})}),ce.jsx("a",{href:`https://github.com/${f.owner.login}/${f.name}/blob/master/README.md`,className:"text-blue-400 transition-transform duration-200 transform hover:scale-150",target:"_blank",rel:"noopener noreferrer",title:"Go to README","aria-label":"External link to project documentation",children:ce.jsx(im,{})})]})]},f.id))}),ce.jsx("hr",{className:"my-4"}),ce.jsx("h2",{className:"text-2xl my-4 text-center",children:"Hugging Face"}),ce.jsx("ul",{className:"list-none list-inside",children:u.map(f=>ce.jsxs("li",{className:"mb-2 px-4 py-3 hover:bg-gray-700 rounded border border-gray-500 border-opacity-50",children:[ce.jsx("span",{className:"block text-left mb-2",children:f.name}),ce.jsx("a",{href:`https://huggingface.co/${f.repo}`,className:"text-blue-400 transition-transform duration-200 transform hover:scale-150",target:"_blank",rel:"noopener noreferrer",title:"See model on Hugging Face","aria-label":"External link to Hugging Face repository",children:ce.jsx(im,{})})]},f.repo))})]})]})]})};var Vt=function(){return Vt=Object.assign||function(e){for(var n,i=1,r=arguments.length;i<r;i++){n=arguments[i];for(var o in n)Object.prototype.hasOwnProperty.call(n,o)&&(e[o]=n[o])}return e},Vt.apply(this,arguments)};function Zo(t,e,n){var i=Z.useRef(e);Z.useEffect(function(){i.current=e}),Z.useEffect(function(){var r=n===void 0?window:n,o=function(s){return i.current(s)};return r==null||r.addEventListener(t,o),function(){r==null||r.removeEventListener(t,o)}},[t,n])}var hA=function(){var t=Z.useState({info:"",Android:function(){return null},BlackBerry:function(){return null},IEMobile:function(){return null},iOS:function(){return null},iPad:function(){return null},OperaMini:function(){return null},any:function(){return!1}}),e=t[0],n=t[1];return Z.useEffect(function(){if(typeof navigator<"u"){var i=navigator.userAgent;n(function(r){return Vt(Vt({},r),{info:i,Android:function(){return i.match(/Android/i)},BlackBerry:function(){return i.match(/BlackBerry/i)},IEMobile:function(){return i.match(/IEMobile/i)},iOS:function(){return i.match(/iPhone|iPad|iPod/i)},iPad:function(){return!!(i.match(/Mac/)&&navigator.maxTouchPoints&&navigator.maxTouchPoints>2)},OperaMini:function(){return i.match(/Opera Mini/i)},any:function(){var o,s,a,l,u;return!!(!((o=r.Android())===null||o===void 0)&&o.length||!((s=r.BlackBerry())===null||s===void 0)&&s.length||!((a=r.iOS())===null||a===void 0)&&a.length||r.iPad()||!((l=r.OperaMini())===null||l===void 0)&&l.length||!((u=r.IEMobile())===null||u===void 0)&&u.length)}})})}},[]),e};function rm(t,e){for(var n=[],i=2;i<arguments.length;i++)n[i-2]=arguments[i];if(typeof e!="function")throw new TypeError("callback must be a function");for(var r=Object(t),o=r.length>>>0,s=n[2],a=0;a<o;a++){var l=r[a];if(e.call(s,l,a,r))return l}}function pA(t){var e=t.clickables,n=e===void 0?["a",'input[type="text"]','input[type="email"]','input[type="number"]','input[type="submit"]','input[type="image"]',"label[for]","select","textarea","button",".link"]:e,i=t.children,r=t.color,o=r===void 0?"220, 90, 90":r,s=t.innerScale,a=s===void 0?.6:s,l=t.innerSize,u=l===void 0?8:l,f=t.innerStyle,d=t.outerAlpha,h=d===void 0?.4:d,m=t.outerScale,_=m===void 0?6:m,x=t.outerSize,p=x===void 0?8:x,c=t.outerStyle,v=t.showSystemCursor,g=v===void 0?!1:v,E=t.trailingSpeed,R=E===void 0?8:E,A=Z.useMemo(function(){return{children:i,color:o,innerScale:a,innerSize:u,innerStyle:f,outerAlpha:h,outerScale:_,outerSize:p,outerStyle:c}},[i,o,a,u,f,h,_,p,c]),T=Z.useRef(null),L=Z.useRef(null),j=Z.useRef(null),y=Z.useRef(null),C=Z.useState({x:0,y:0}),J=C[0],Q=C[1],b=Z.useState(!1),X=b[0],W=b[1],$=Z.useState(A),P=$[0],I=$[1],H=Z.useState(!1),q=H[0],ne=H[1],Ce=Z.useState(!1),O=Ce[0],K=Ce[1],le=Z.useRef(0),Te=Z.useRef(0),ye=Z.useCallback(function(Se){var he=Se.clientX,qe=Se.clientY;Q({x:he,y:qe}),L.current!==null&&(L.current.style.top="".concat(qe,"px"),L.current.style.left="".concat(he,"px")),le.current=he,Te.current=qe},[]),ge=Z.useCallback(function(Se){y.current!==void 0&&(J.x+=(le.current-J.x)/R,J.y+=(Te.current-J.y)/R,T.current!==null&&(T.current.style.top="".concat(J.y,"px"),T.current.style.left="".concat(J.x,"px"))),y.current=Se,j.current=requestAnimationFrame(ge)},[j]);Z.useEffect(function(){return j.current=requestAnimationFrame(ge),function(){j.current!==null&&cancelAnimationFrame(j.current)}},[ge]);var $e=function(Se,he){return"".concat(parseInt(String(Se*he)),"px")},Ee=Z.useCallback(function(Se,he,qe){Se&&(Se.style.height=$e(he,qe),Se.style.width=$e(he,qe))},[]),U=Z.useCallback(function(){return ne(!0)},[]),xt=Z.useCallback(function(){return ne(!1)},[]),Me=Z.useCallback(function(){return W(!0)},[]),Ue=Z.useCallback(function(){return W(!1)},[]);Zo("mousemove",ye),Zo("mousedown",U),Zo("mouseup",xt),Zo("mouseover",Me),Zo("mouseout",Ue),Z.useEffect(function(){q?(Ee(L.current,P.innerSize,P.innerScale),Ee(T.current,P.outerSize,P.outerScale)):(Ee(L.current,P.innerSize,1),Ee(T.current,P.outerSize,1))},[P.innerSize,P.innerScale,P.outerSize,P.outerScale,Ee,q]),Z.useEffect(function(){O&&(Ee(L.current,P.innerSize,P.innerScale*1.2),Ee(T.current,P.outerSize,P.outerScale*1.4))},[P.innerSize,P.innerScale,P.outerSize,P.outerScale,Ee,O]),Z.useEffect(function(){L.current==null||T.current==null||(X?(L.current.style.opacity="1",T.current.style.opacity="1"):(L.current.style.opacity="0",T.current.style.opacity="0"))},[X]),Z.useEffect(function(){var Se=document.querySelectorAll(n.map(function(he){return typeof he=="object"&&(he!=null&&he.target)?he.target:he??""}).join(","));return Se.forEach(function(he){g||(he.style.cursor="none");var qe=typeof n=="object"?rm(n,function(S){return typeof S=="object"&&he.matches(S.target)}):{},w=Vt(Vt({},A),qe);he.addEventListener("mouseover",function(){ne(!0),I(w)}),he.addEventListener("click",function(){ne(!0),K(!1)}),he.addEventListener("mousedown",function(){K(!0)}),he.addEventListener("mouseup",function(){ne(!0)}),he.addEventListener("mouseout",function(){ne(!1),K(!1),I(A)})}),function(){Se.forEach(function(he){var qe=typeof n=="object"?rm(n,function(S){return typeof S=="object"&&he.matches(S.target)}):{},w=Vt(Vt({},A),qe);he.removeEventListener("mouseover",function(){ne(!0),I(w)}),he.removeEventListener("click",function(){ne(!0),K(!1)}),he.removeEventListener("mousedown",function(){K(!0)}),he.removeEventListener("mouseup",function(){ne(!0)}),he.removeEventListener("mouseout",function(){ne(!1),K(!1),I(A)})})}},[q,n,g,A]),Z.useEffect(function(){typeof window=="object"&&!g&&(document.body.style.cursor="none")},[g]);var Ae={zIndex:999,display:"flex",justifyContent:"center",alignItems:"center",position:"fixed",borderRadius:"50%",pointerEvents:"none",transform:"translate(-50%, -50%)",transition:"opacity 0.15s ease-in-out, height 0.2s ease-in-out, width 0.2s ease-in-out"},He={cursorInner:Vt(Vt({width:P.children?"auto":P.innerSize,height:P.children?"auto":P.innerSize,backgroundColor:P.children?"transparent":"rgba(".concat(P.color,", 1)")},Ae),P.innerStyle&&P.innerStyle),cursorOuter:Vt(Vt({width:P.outerSize,height:P.outerSize,backgroundColor:"rgba(".concat(P.color,", ").concat(P.outerAlpha,")")},Ae),P.outerStyle&&P.outerStyle)};return ce.jsxs(ce.Fragment,{children:[ce.jsx("div",{ref:T,style:He.cursorOuter}),ce.jsx("div",Vt({ref:L,style:He.cursorInner},{children:ce.jsx("div",Vt({style:{opacity:P.children?1:0,transition:"opacity 0.3s ease-in-out"}},{children:P.children}))}))]})}function mA(t){var e=t.children,n=t.clickables,i=t.color,r=t.innerScale,o=t.innerSize,s=t.innerStyle,a=t.outerAlpha,l=t.outerScale,u=t.outerSize,f=t.outerStyle,d=t.showSystemCursor,h=t.trailingSpeed,m=hA();return typeof navigator<"u"&&m.any()?ce.jsx(ce.Fragment,{}):ce.jsx(pA,Vt({clickables:n,color:i,innerScale:r,innerSize:o,innerStyle:s,outerAlpha:a,outerScale:l,outerSize:u,outerStyle:f,showSystemCursor:d,trailingSpeed:h},{children:e}))}function gA(t){return Io({tag:"svg",attr:{viewBox:"0 0 512 512"},child:[{tag:"path",attr:{d:"M96.85 286.62a8 8 0 0 0-12.53 8.25C102.07 373.28 172.3 432 256 432a175.31 175.31 0 0 0 52.41-8 8 8 0 0 0 .79-15 1120 1120 0 0 1-109.48-55.61 1126.24 1126.24 0 0 1-102.87-66.77zm395.87 52.89c-4.19-5.58-9.11-11.44-14.7-17.53a15.83 15.83 0 0 0-26.56 5.13c0 .16-.11.31-.17.47a15.75 15.75 0 0 0 3.15 16.06c22.74 25 26.42 38.51 25.48 41.36-2 2.23-17.05 6.89-58.15-3.53q-8.83-2.24-19.32-5.46-6.76-2.08-13.79-4.49a176.76 176.76 0 0 0 19.54-27.25c.17-.29.35-.58.52-.88A175.39 175.39 0 0 0 432 256a178.87 178.87 0 0 0-1-19c-9.57-88.17-84.4-157-175-157a175.37 175.37 0 0 0-106.4 35.89 177.4 177.4 0 0 0-45.83 51.84c-.16.29-.34.58-.51.87a175.48 175.48 0 0 0-13.83 30.52q-5.59-4.87-10.79-9.67c-5.39-5-10.17-9.63-14.42-14-29.57-30.26-33.09-45.61-32.16-48.45 2-2.23 15.54-5.87 48.62 1.31A15.82 15.82 0 0 0 96.22 123l.36-.44a15.74 15.74 0 0 0-8.67-25.43A237.38 237.38 0 0 0 64.13 93c-30.72-3.53-50.83 2.52-59.78 18-3.24 5.58-6.35 15.09-2.72 28.6C7 159.66 26.14 184 53.23 209.5c8.63 8.13 18.06 16.37 28.12 24.64 7.32 6 15 12.06 22.9 18.08q7.91 6 16.15 12T137.1 276c25.41 17.61 52.26 34.52 78.59 49.69q14.34 8.26 28.64 16t28.37 14.81c21.9 11 43.35 20.92 63.86 29.43q13.19 5.48 25.81 10.16c11.89 4.42 23.37 8.31 34.31 11.59l1.1.33c25.73 7.66 47.42 11.69 64.48 12H464c21.64 0 36.3-6.38 43.58-19 9.09-15.62 4.08-36.32-14.86-61.5z"},child:[]}]})(t)}const vA=Z.createContext(void 0),_A=({children:t,className:e,containerClassName:n})=>{const i=Z.useRef(null),[r,o]=Z.useState(!1),s=a=>{if(!i.current)return;const{left:l,top:u,width:f,height:d}=i.current.getBoundingClientRect(),h=(a.clientX-l-f/2)/25,m=-(a.clientY-u-d/2)/25;i.current.style.transform=`rotateY(${h}deg) rotateX(${m}deg)`};return Z.useEffect(()=>(window.addEventListener("mousemove",s),()=>{window.removeEventListener("mousemove",s)}),[]),ce.jsx(vA.Provider,{value:[r,o],children:ce.jsx("div",{className:"py-10 flex items-center justify-center "+(n||""),style:{perspective:"1000px"},children:ce.jsx("div",{ref:i,className:"flex items-center justify-center relative transition-all duration-200 ease-linear "+(e||""),style:{transformStyle:"preserve-3d"},children:t})})})},xA=({children:t,className:e})=>ce.jsx("div",{className:"h-96 w-96 [transform-style:preserve-3d]  [&>*]:[transform-style:preserve-3d] "+(e||""),children:t}),om=({as:t="div",children:e,className:n,translateX:i=0,translateY:r=0,translateZ:o=0,rotateX:s=0,rotateY:a=0,rotateZ:l=0,...u})=>{const f=Z.useRef(null),d=Z.useCallback(()=>{f.current&&(f.current.style.transform=`translateX(${i}px) translateY(${r}px) translateZ(${o}px) rotateX(${s}deg) rotateY(${a}deg) rotateZ(${l}deg)`)},[s,a,l,i,r,o]);return Z.useEffect(()=>{d()},[d]),ce.jsx(t,{ref:f,className:"w-fit transition duration-200 ease-linear "+(n||""),...u,children:e})},yA=()=>ce.jsx(_A,{className:"w-full sm:w-80 p-4 sm:p-6",children:ce.jsxs(xA,{className:"bg-gray-50 relative group/card  dark:hover:shadow-2xl dark:hover:shadow-emerald-500/[0.1] dark:bg-black dark:border-white/[0.2] border-black/[0.1] w-full sm:w-[30rem] h-auto rounded-xl p-6 border  ",children:[ce.jsx(om,{className:"text-xl mb-2 font-bold mx-auto text-neutral-600 dark:text-white",children:"Check out my projects, or contact me!"}),ce.jsxs(om,{translateZ:"75",className:"flex flex-col sm:flex-row justify-center sm:justify-around items-center w-full mt-4",children:[ce.jsx("div",{className:"flex flex-col items-center logo svg",children:ce.jsxs("a",{href:"https://github.com/jwt2706",target:"_blank",rel:"noopener noreferrer",className:"w-1/2 p-4 flex flex-col items-center",children:[ce.jsx(uA,{size:110,color:"black"}),ce.jsx("p",{className:"mt-4 mb-2 underline-animation",children:"github.com/jwt2706"})]})}),ce.jsx("div",{className:"flex flex-col items-center logo svg",children:ce.jsxs("a",{href:"mailto:work@jwt2706.ca",className:"w-1/2 p-4 flex flex-col items-center",children:[ce.jsx(cA,{size:110,color:"black"}),ce.jsx("p",{className:"mt-4 mb-2 underline-animation",children:"work@jwt2706.ca"})]})})]})]})});function SA(t){return Io({tag:"svg",attr:{viewBox:"0 0 24 24",fill:"none",stroke:"currentColor",strokeWidth:"2",strokeLinecap:"round",strokeLinejoin:"round"},child:[{tag:"circle",attr:{cx:"12",cy:"12",r:"10"},child:[]},{tag:"path",attr:{d:"M15 9.354a4 4 0 1 0 0 5.292"},child:[]}]})(t)}const EA=()=>{const t=Z.useState("ontouchstart"in window||navigator.maxTouchPoints>0||navigator.maxTouchPoints>0);return ce.jsx("div",{className:"animate-fade-in",children:ce.jsxs("div",{className:"app flex flex-col min-h-screen text-white",children:[ce.jsx(dA,{}),ce.jsxs("main",{className:"scrollable flex-grow overflow-y-auto",children:[!t&&ce.jsx(mA,{innerSize:20,outerSize:16,color:"265, 265, 265",outerAlpha:.2,innerScale:.7,outerScale:5,clickables:["a",'input[type="text"]','input[type="email"]','input[type="number"]','input[type="submit"]','input[type="image"]',"label[for]","select","textarea","button",".link"]}),ce.jsxs("div",{children:[ce.jsx("br",{}),ce.jsx("div",{className:"mx-auto inline-block p-4",children:ce.jsx("div",{className:"transition-transform duration-500 ease-in-out hover:scale-130",children:ce.jsx(gA,{size:110,color:"black"})})}),ce.jsx("br",{}),ce.jsx("h1",{children:ce.jsx("span",{className:"text-4xl underline-animation",children:"Hey, I'm Jacob"})}),ce.jsx("br",{}),ce.jsx("code",{className:"text-gray-400",children:"Software engineering undergrad."})]}),ce.jsx(yA,{})]}),ce.jsx("footer",{children:ce.jsxs("code",{children:["Coded with care. ",ce.jsx(SA,{style:{display:"inline"}})," ","jwt2706 ",new Date().getFullYear()]})}),ce.jsx(tA,{})]})})},MA=()=>{const t=Pv();return Z.useEffect(()=>{t("/")},[t]),yy([{path:"/",element:ce.jsx(EA,{})},{path:"*",element:ce.jsx(Ny,{to:"/",replace:!0})}])},TA=()=>ce.jsx(Oy,{children:ce.jsx(MA,{})});nc.createRoot(document.getElementById("root")).render(Mn.createElement(Mn.StrictMode,null,Mn.createElement(TA,null)));
